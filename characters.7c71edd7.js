...
try{await (0,s.api).getCharacters({offset:offset,nameStartsWith:queryName,comics:h,orderBy:queryOrder,modifiedSince:dateQuery}),console.log("queryName =>",queryName)}catch(e){}(0,o.hideLoader)()}catch(e){(0,o.hideLoader)(),console.log(e)}};l.addEventListener("submit",g);//# sourceMappingURL=characters.7c71edd7.js.map

//# sourceMappingURL=characters.7c71edd7.js.map
