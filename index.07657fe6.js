 ...
 */function(t){return"undefined"!=typeof ArrayBuffer&&ArrayBuffer.isView?ArrayBuffer.isView(t):t&&t.buffer&&O(t.buffer)},isString:B,isNumber:R,isBoolean:t=>!0===t||!1===t,isObject:T,isPlainObject:U,isUndefined:v,isDate:C,isFile:x,isBlob:I,isRegExp:$,isFunction:S,isStream:t=>T(t)&&S(t.pipe),isURLSearchParams:_,isTypedArray:D,isFileList:N,forEach:L,merge:/**
...
console.warn(n(o," has been deprecated since v"+e+" and will be removed in the near future"))),!t||t(r,o,i)}};var ev={assertOptions:/**
 ...
 *
 * @returns {object}
 */function(t,e,r){if("object"!=typeof t)throw new G("options must be an object",G.ERR_BAD_OPTION_VALUE);let n=Object.keys(t),o=n.length;for(;o-- >0;){let i=n[o],s=e[i];if(s){let e=t[i],r=void 0===e||s(e,i,t);if(!0!==r)throw new G("option "+i+" must be "+r,G.ERR_BAD_OPTION_VALUE);continue}if(!0!==r)throw new G("Unknown option "+i,G.ERR_BAD_OPTION)}},validators:eE};const eO=ev.validators;/**
...
const{Axios:eU,AxiosError:eC,CanceledError:ex,isCancel:eI,CancelToken:eN,VERSION:e_,all:eL,Cancel:ej,isAxiosError:eP,spread:eF,toFormData:eD,AxiosHeaders:ek,HttpStatusCode:eM,formToJSON:e$,getAdapter:eq,mergeConfig:ez}=eT;var eH={};n=d("fSg2G"),o=d("28Nm5").utf8,i=d("c8cSi"),s=d("28Nm5").bin,// Auxiliary functions
...
a._blocksize=16,a._digestsize=16,eH=function(t,e){if(null==t)throw Error("Illegal argument "+t);var r=n.wordsToBytes(a(t,e));return e&&e.asBytes?r:e&&e.asString?s.bytesToString(r):n.bytesToHex(r)};const eW="efe513042744199e2ee71f94d9988717",eJ=eT.create({baseURL:"https://gateway.marvel.com/v1/public",params:{apikey:eW,hash:(({timeStamp:t,PUBLIC_KEY:e,PRIVATE_KEY:r})=>{var n;return((n=eH)&&n.__esModule?n.default:n)(`${t}${r}${e}`)})({timeStamp:1,PRIVATE_KEY:"5488535f3958164a14b37ef40df2b28b6e569641",PUBLIC_KEY:eW}),ts:1}}),eV={getCharacters:async({limit:t=20,offset:e=0,nameStartsWith:r="",comics:n="",orderBy:o="",modifiedSince:i=""})=>{try{let s=await eJ.get("/characters",{params:{...t&&{limit:t},...e&&{offset:e},...r&&{nameStartsWith:r},...n&&{comics:n},...o&&{orderBy:o},...i&&{modifiedSince:i}}}),a=s.data.data;return a}catch(t){return console.log(t),{error:t.message}}}},eG=document.querySelector(".js-header-search"),eK=document.querySelector(".js-header-form");let eY=null;eY=(()=>{let t={mobile:320,tablet:768};return window.innerWidth<=t.mobile?5:window.innerWidth<=t.tablet?8:16})();const eX=t=>t.map(t=>`<li class="header-search-item">
    ...
    `).join(""),eQ=t=>{eG.insertAdjacentHTML("beforeend",eX(t))},eZ=async t=>{t.preventDefault();let{target:e}=t,r=e.elements.searchQuery.value;if(eK.reset(),""!==r)try{let t=await eV.getCharacters({nameStartsWith:r,limit:eY,offset:0});if(0===t.results.length){eG.innerHTML='<div class="nothing-seach"></div>';return}eQ(t.results)}catch(t){console.log("Error!",t)}};eK.addEventListener("submit",eZ),new Swiper(".section-hero-swiper",{direction:"vertical",loop:!0,pagination:{el:".swiper-pagination",clickable:!0},spaceBetween:50,slidesPerView:1,initialSlide:0});const e0=document.querySelector(".swiper-pagination"),e1=document.querySelector(".js-btn-color");e0.addEventListener("click",t=>{let{target:e}=t,r=e.getAttribute("aria-label"),n="";"Go to slide 1"===r?(n="#600404",e1.style.background=n):"Go to slide 2"===r?(n="#34387f",e1.style.background=n):"Go to slide 3"===r&&(n="#5b7f3c",e1.style.background=n)});/* swiperSlideHero *///# sourceMappingURL=index.07657fe6.js.map

//# sourceMappingURL=index.07657fe6.js.map
