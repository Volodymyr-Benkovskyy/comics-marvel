...
let rs=document.querySelector(".js-random-img"),ra=document.querySelector(".js-random-descr"),rl=t=>{let e=t.map(({id:t,thumbnail:e,name:r})=>`  <li class= "js-slide js-random-characters-img" data-id="${t}">
      <picture>
    ...
    </li>`).join("");return e},rE=t=>{rb.insertAdjacentHTML("beforeend",rw(t))},rv=async()=>{try{let t=await eV.getComics({limit:3,dateDescriptor:"lastWeek"});rE(t.results)}catch(t){console.log(t)}};rv(),new Swiper(".section-comics-swiper",{slidesPerView:1,spaceBetween:15,scrollbar:{el:".swiper-scrollbar",draggable:!0},breakpoints:{375:{slidesPerView:1},768:{slidesPerView:1.5},1440:{slidesPerView:3,init:!1}}})}();//# sourceMappingURL=index.563c85cb.js.map

//# sourceMappingURL=index.563c85cb.js.map
