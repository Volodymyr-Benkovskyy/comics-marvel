...
console.log("Error!",e)}};eo.addEventListener("input",/*@__PURE__*/e(c)(eD,2e3)),ei.addEventListener("change",eD);const eC=document.querySelector(".js-header-chararcters-input"),eM=document.getElementById("characters-list"),ew=()=>{eM.scrollIntoView({behavior:"smooth"})};eC.addEventListener("input",/*@__PURE__*/e(c)(()=>{eC.value="",ew()},200));const e_=document.querySelector(".header");window.addEventListener("scroll",()=>{0!==scrollY?e_.classList.add("js-header-bg"):e_.classList.remove("js-header-bg")});//# sourceMappingURL=characters.93c01c8e.js.map

//# sourceMappingURL=characters.93c01c8e.js.map
