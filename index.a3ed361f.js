 ...
 */function(t){return"undefined"!=typeof ArrayBuffer&&ArrayBuffer.isView?ArrayBuffer.isView(t):t&&t.buffer&&O(t.buffer)},isString:B,isNumber:S,isBoolean:t=>!0===t||!1===t,isObject:T,isPlainObject:U,isUndefined:A,isDate:x,isFile:C,isBlob:I,isRegExp:$,isFunction:R,isStream:t=>T(t)&&R(t.pipe),isURLSearchParams:_,isTypedArray:k,isFileList:N,forEach:L,merge:/**
...
let i=!1;for(;;)switch(e){case"ascii":case"latin1":case"binary":return r;case"utf8":case"utf-8":return tN(t).length;case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":return 2*r;case"hex":return r>>>1;case"base64":return t_(t).length;default:if(i)return n?-1:tN(t).length// assume utf8
...
// ================
let tI=/[^+/0-9A-Za-z-_]/g;function tN(t,e){let r;e=e||1/0;let n=t.length,i=null,o=[];for(let s=0;s<n;++s){// is surrogate component
...
if(i=null,r<128){if((e-=1)<0)break;o.push(r)}else if(r<2048){if((e-=2)<0)break;o.push(r>>6|192,63&r|128)}else if(r<65536){if((e-=3)<0)break;o.push(r>>12|224,r>>6&63|128,63&r|128)}else if(r<1114112){if((e-=4)<0)break;o.push(r>>18|240,r>>12&63|128,r>>6&63|128,63&r|128)}else throw Error("Invalid code point")}return o}function t_(t){return function(t){var e,r,n=function(t){var e=t.length;if(e%4>0)throw Error("Invalid string. Length must be a multiple of 4");// Trim off extra bytes after placeholder bytes are found
...
let{Axios:eU,AxiosError:ex,CanceledError:eC,isCancel:eI,CancelToken:eN,VERSION:e_,all:eL,Cancel:ej,isAxiosError:eP,spread:eF,toFormData:ek,AxiosHeaders:eD,HttpStatusCode:eM,formToJSON:e$,getAdapter:ez,mergeConfig:eq}=eT;var eH={};n=d("19JXX"),i=d("h0JH0").utf8,o=d("gixTh"),s=d("h0JH0").bin,// Auxiliary functions
 ...
 */function eQ(t,e){return"string"==typeof t?t:t[e%t.length]}let e0=new(0,eK.Spinner)({lines:16,length:18,width:4,radius:20,color:"#600404"}).spin(),e1=()=>{let t=document.getElementById("loader-container");t.innerHTML="",t.appendChild(e0.el),t.style.display="flex"},e2=()=>{let t=document.getElementById("loader-container");t.style.display="none",t.innerHTML=""},e6=document.querySelector(".js-header-search"),e5=document.querySelector(".js-header-form"),e4=null;e4=(()=>{let t={mobile:320,tablet:768};return window.innerWidth<=t.mobile?5:window.innerWidth<=t.tablet?8:16})();let e3=t=>t.map(t=>`<li class="header-search-item">
    ...
    `).join(""),e8=t=>{e6.insertAdjacentHTML("beforeend",e3(t))},e7=()=>{e6.scrollIntoView({behavior:"smooth"})},e9=()=>{e6.innerHTML=""},rt=async t=>{t.preventDefault();let{target:e}=t,r=e.elements.searchQuery.value;if(e5.reset(),""!==r)try{e1();let t=await eV.getCharacters({nameStartsWith:r,limit:e4,offset:0});if(0===t.results.length){e2(),e7(),e6.innerHTML='<div class="nothing-seach"></div>';return}e2(),e9(),e8(t.results),e7()}catch(t){location.replace("../error.html"),e2()}};e5.addEventListener("submit",rt),new Swiper(".section-hero-swiper",{direction:"vertical",loop:!0,pagination:{el:".swiper-pagination",clickable:!0},spaceBetween:50,slidesPerView:1,initialSlide:0});let re=document.querySelector(".swiper-pagination"),rr=document.querySelector(".js-btn-color");re.addEventListener("click",t=>{let{target:e}=t,r=e.getAttribute("aria-label"),n="";"Go to slide 1"===r?(n="#600404",rr.style.background=n):"Go to slide 2"===r?(n="#34387f",rr.style.background=n):"Go to slide 3"===r&&(n="#5b7f3c",rr.style.background=n)})}();//# sourceMappingURL=index.a3ed361f.js.map

//# sourceMappingURL=index.a3ed361f.js.map
