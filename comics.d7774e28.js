...
const i=document.querySelector(".header-comics");window.addEventListener("scroll",()=>{0!==scrollY?i.classList.add("js-header-bg-comics"):i.classList.remove("js-header-bg-comics")});var r=o("iRoAB"),a=o("jKGAa"),c=o("cH1ne"),l=o("fb9GJ");let n="",d="",m="",u="",h=null;h=(0,c.getItemsPerPage)();const f=document.querySelector(".js-comics-sort-form"),g=document.querySelector(".js-comics-sort-container"),v=document.getElementById("comics-list"),L=e=>e.map(({id:e,thumbnail:t,title:s})=>`<li class="comics-sort-item">
    ...
    `).join(""),p=()=>{g.innerHTML=""},y=e=>{g.insertAdjacentHTML("beforeend",L(e))},w=()=>{v.scrollIntoView({behavior:"smooth"})},b=document.querySelector(".tui-pagination"),j={totalItems:0,itemsPerPage:h,visiblePages:3},S=new(l&&l.__esModule?l.default:l)(b,j),q=async()=>{(0,a.showLoader)();try{let e=await (0,r.api).getComics({limit:h,offset:0});(0,a.hideLoader)(),p(),y(e.results),b.classList.remove("is-hidden"),S.reset(e.total),S.on("beforeMove",async t=>{let s=t.page,o=h*(s+1);try{(0,a.showLoader)();let t=await (0,r.api).getComics({offset:o,limit:h,titleStartsWith:n,format:d,orderBy:m});(0,a.hideLoader)(),S.reset(e.total),p(),y(t.results),w(),b.classList.remove("is-hidden")}catch(e){}})}catch(e){}};q();const E=document.querySelector(".js-comics-input-title"),T=document.querySelector(".js-comics-select-format"),x=document.querySelector(".js-comics-select-order"),M=document.querySelector(".js-comics-select-year");M.insertAdjacentHTML("afterbegin",(()=>{let e=[];for(let t=2023;t>1949;t-=1)e.push(`<option>${t}</option>`);return e.join("")})());const $=async e=>{if(e.preventDefault(),e.target===E)n=E.value;else if(e.target===T)d=T.value;else if(e.target===x){let e=x.value;"Title"===e?m="title":"On Sale Date"===e&&(m="onsaleDate")}else e.target===M&&(u=M.value);try{(0,a.showLoader)();let e=await (0,r.api).getComics({limit:h,titleStartsWith:n,format:d,orderBy:m,startYear:u});if(console.log(e),0===e.results.length){g.innerHTML='<div class="nothing-seach"></div>',b.classList.add("is-hidden"),(0,a.hideLoader)();return}(0,a.hideLoader)(),S.reset(e.total),p(),y(e.results),w(),b.classList.remove("is-hidden"),E.value=""}catch(e){(0,a.hideLoader)(),console.log(e)}};M.addEventListener("change",$),x.addEventListener("change",$),T.addEventListener("change",$),f.addEventListener("submit",$);//inputTitleEl.addEventListener('input', fechTitleFormatOrderDate);
//# sourceMappingURL=comics.d7774e28.js.map
