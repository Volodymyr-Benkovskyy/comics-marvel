...
v.mergeConfig=s.default,v.AxiosHeaders=b.default,v.formToJSON=t=>(0,f.default)((0,n.default).isHTMLForm(t)?new FormData(t):t),v.getAdapter=x.default.getAdapter,v.HttpStatusCode=w.default,v.default=v;var E=v}),i.register("c4C4W",function(r,n){t(r.exports,"default",function(){return $});var o,a,s=i("lGmLA");// utils is a library of generic helper functions non-specific to axios
...
let o=r?Object.getOwnPropertyNames(t):Object.keys(t),a=o.length;for(n=0;n<a;n++)i=o[n],e.call(null,t[i],i,t)}}}function C(t,e){let r;e=e.toLowerCase();let n=Object.keys(t),i=n.length;for(;i-- >0;)if(e===(r=n[i]).toLowerCase())return r;return null}let O=/*eslint no-undef:0*/"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:e,k=t=>!h(t)&&t!==O,I=(a="undefined"!=typeof Uint8Array&&f(Uint8Array),t=>a&&t instanceof a),T=c("HTMLFormElement"),R=(({hasOwnProperty:t})=>(e,r)=>t.call(e,r))(Object.prototype),L=c("RegExp"),U=(t,e)=>{let r=Object.getOwnPropertyDescriptors(t),n={};S(r,(r,i)=>{let o;!1!==(o=e(r,i,t))&&(n[i]=o||r)}),Object.defineProperties(t,n)},j="abcdefghijklmnopqrstuvwxyz",P="0123456789",D={DIGIT:P,ALPHA:j,ALPHA_DIGIT:j+j.toUpperCase()+P},_=c("AsyncFunction");var $={isArray:p,isArrayBuffer:m,isBuffer:/**
 ...
 */function(t){return"undefined"!=typeof ArrayBuffer&&ArrayBuffer.isView?ArrayBuffer.isView(t):t&&t.buffer&&m(t.buffer)},isString:y,isNumber:b,isBoolean:t=>!0===t||!1===t,isObject:x,isPlainObject:w,isUndefined:h,isDate:v,isFile:E,isBlob:A,isRegExp:L,isFunction:g,isStream:t=>x(t)&&g(t.pipe),isURLSearchParams:N,isTypedArray:I,isFileList:B,forEach:S,merge:/**
...
(0,n.default).forEach(["delete","get","head","options"],function(t){/*eslint func-names:0*/p.prototype[t]=function(e,r){return this.request((0,l.default)(r||{},{method:t,url:e,data:(r||{}).data}))}}),(0,n.default).forEach(["post","put","patch"],function(t){/*eslint func-names:0*/function e(e){return function(r,n,i){return this.request((0,l.default)(i||{},{method:t,headers:e?{"Content-Type":"multipart/form-data"}:{},url:r,data:n}))}}p.prototype[t]=e(),p.prototype[t+"Form"]=e(!0)});var h=p}),i.register("6d5Pb",function(e,r){t(e.exports,"default",function(){return s});var n=i("c4C4W"),o=i("8zJup");/**
 ...
 */function a(t){return encodeURIComponent(t).replace(/%3A/gi,":").replace(/%24/g,"$").replace(/%2C/gi,",").replace(/%20/g,"+").replace(/%5B/gi,"[").replace(/%5D/gi,"]")}function s(t,e,r){let i;/*eslint no-param-reassign:0*/if(!e)return t;let s=r&&r.encode||a,l=r&&r.serialize;if(i=l?l(e,r):(0,n.default).isURLSearchParams(e)?e.toString():new(0,o.default)(e,r).toString(s)){let e=t.indexOf("#");-1!==e&&(t=t.slice(0,e)),t+=(-1===t.indexOf("?")?"?":"&")+i}return t}}),i.register("8zJup",function(e,r){t(e.exports,"default",function(){return l});var n=i("12Kat");/**
 ...
 *
 * @returns {void}
 */function a(t,e){this._pairs=[],t&&(0,n.default)(t,this,e)}let s=a.prototype;s.append=function(t,e){this._pairs.push([t,e])},s.toString=function(t){let e=t?function(e){return t.call(this,e,o)}:o;return this._pairs.map(function(t){return e(t[0])+"="+e(t[1])},"").join("&")};var l=a}),i.register("12Kat",function(e,r){t(e.exports,"default",function(){return d});var n=i("c4C4W"),o=i("5TB86"),a=i("beknR"),s=i("3aNd6").Buffer;/**
...
r=f(r),a.forEach(function(t,i){(0,n.default).isUndefined(t)||null===t||e.append(!0===h?u([r],i,p):null===h?r:r+"[]",g(t))}),!1)}}return!!l(t)||(e.append(u(o,r,p),g(t)),!1)}let x=[],w=Object.assign(c,{defaultVisitor:b,convertValue:g,isVisitable:l});if(!(0,n.default).isObject(t))throw TypeError("data must be an object");return function t(r,i){if(!(0,n.default).isUndefined(r)){if(-1!==x.indexOf(r))throw Error("Circular reference detected in "+i.join("."));x.push(r),(0,n.default).forEach(r,function(r,o){let a=!((0,n.default).isUndefined(r)||null===r)&&d.call(e,r,(0,n.default).isString(o)?o.trim():o,i,w);!0===a&&t(r,i?i.concat(o):[o])}),x.pop()}}(t),e}}),i.register("5TB86",function(e,r){t(e.exports,"default",function(){return l});var n=i("c4C4W");/**
...
o.from=(t,e,r,i,s,l)=>{let f=Object.create(a);return(0,n.default).toFlatObject(t,f,function(t){return t!==Error.prototype},t=>"isAxiosError"!==t),o.call(f,t.message,e,r,i,s),f.cause=t,f.name=t.name,l&&Object.assign(f,l),f};var l=o}),i.register("beknR",function(e,r){t(e.exports,"default",function(){return n});// eslint-disable-next-line strict
var n=null}),i.register("3aNd6",function(e,r){t(e.exports,"Buffer",function(){return n},function(t){return n=t}),t(e.exports,"INSPECT_MAX_BYTES",function(){return o},function(t){return o=t});var n,o,a=i("5d11t"),s=i("7rddL");let l="function"==typeof Symbol&&"function"// eslint-disable-line dot-notation
...
let i=!1;for(;;)switch(e){case"ascii":case"latin1":case"binary":return r;case"utf8":case"utf-8":return D(t).length;case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":return 2*r;case"hex":return r>>>1;case"base64":return _(t).length;default:if(i)return n?-1:D(t).length// assume utf8
...
let I={};function T(t,e,r){I[t]=class extends r{constructor(){super(),Object.defineProperty(this,"message",{value:e.apply(this,arguments),writable:!0,configurable:!0}),// Add the error code to the name to include it in the stack trace.
this.name=`${this.name} [${t}]`,// Access the stack to generate the error message including the error code
// from the name.
this.stack// eslint-disable-line no-unused-expressions
,// Reset the name to the actual name.
delete this.name}get code(){return t}set code(t){Object.defineProperty(this,"code",{configurable:!0,enumerable:!0,value:t,writable:!0})}toString(){return`${this.name} [${t}]: ${this.message}`}}}function R(t){let e="",r=t.length,n="-"===t[0]?1:0;for(;r>=n+4;r-=3)e=`_${t.slice(r-3,r)}${e}`;return`${t.slice(0,r)}${e}`}function L(t,e,r,n,i,o){if(t>r||t<e){let n;let i="bigint"==typeof e?"n":"";throw n=o>3?0===e||e===BigInt(0)?`>= 0${i} and < 2${i} ** ${(o+1)*8}${i}`:`>= -(2${i} ** ${(o+1)*8-1}${i}) and < 2 ** ${(o+1)*8-1}${i}`:`>= ${e}${i} and <= ${r}${i}`,new I.ERR_OUT_OF_RANGE("value",n,t)}U(i,"offset"),(void 0===n[i]||void 0===n[i+o])&&j(i,n.length-(o+1))}function U(t,e){if("number"!=typeof t)throw new I.ERR_INVALID_ARG_TYPE(e,"number",t)}function j(t,e,r){if(Math.floor(t)!==t)throw U(t,r),new I.ERR_OUT_OF_RANGE(r||"offset","an integer",t);if(e<0)throw new I.ERR_BUFFER_OUT_OF_BOUNDS;throw new I.ERR_OUT_OF_RANGE(r||"offset",`>= ${r?1:0} and <= ${e}`,t)}T("ERR_BUFFER_OUT_OF_BOUNDS",function(t){return t?`${t} is outside of buffer bounds`:"Attempt to access memory outside buffer bounds"},RangeError),T("ERR_INVALID_ARG_TYPE",function(t,e){return`The "${t}" argument must be of type number. Received type ${typeof e}`},TypeError),T("ERR_OUT_OF_RANGE",function(t,e,r){let n=`The value of "${t}" is out of range.`,i=r;return Number.isInteger(r)&&Math.abs(r)>4294967296?i=R(String(r)):"bigint"==typeof r&&(i=String(r),(r>BigInt(2)**BigInt(32)||r<-(BigInt(2)**BigInt(32)))&&(i=R(i)),i+="n"),n+=` It must be ${e}. Received ${i}`},RangeError);// HELPER FUNCTIONS
// ================
let P=/[^+/0-9A-Za-z-_]/g;function D(t,e){let r;e=e||1/0;let n=t.length,i=null,o=[];for(let a=0;a<n;++a){// is surrogate component
...
if(i=null,r<128){if((e-=1)<0)break;o.push(r)}else if(r<2048){if((e-=2)<0)break;o.push(r>>6|192,63&r|128)}else if(r<65536){if((e-=3)<0)break;o.push(r>>12|224,r>>6&63|128,63&r|128)}else if(r<1114112){if((e-=4)<0)break;o.push(r>>18|240,r>>12&63|128,r>>6&63|128,63&r|128)}else throw Error("Invalid code point")}return o}function _(t){return a.toByteArray(function(t){// Node converts strings with length < 2 to ''
...
for(;t.length%4!=0;)t+="=";return t}(t))}function $(t,e,r,n){let i;for(i=0;i<n&&!(i+r>=e.length)&&!(i>=t.length);++i)e[i+r]=t[i];return i}// ArrayBuffer or Uint8Array objects from other contexts (i.e. iframes) do not pass
...
a["-".charCodeAt(0)]=62,a["_".charCodeAt(0)]=63}),i.register("7rddL",function(e,r){var n,i;t(e.exports,"read",function(){return n},function(t){return n=t}),t(e.exports,"write",function(){return i},function(t){return i=t}),n=function(t,e,r,n,i){var o,a,s=8*i-n-1,l=(1<<s)-1,f=l>>1,u=-7,c=r?i-1:0,d=r?-1:1,p=t[e+c];for(c+=d,o=p&(1<<-u)-1,p>>=-u,u+=s;u>0;o=256*o+t[e+c],c+=d,u-=8);for(a=o&(1<<-u)-1,o>>=-u,u+=n;u>0;a=256*a+t[e+c],c+=d,u-=8);if(0===o)o=1-f;else{if(o===l)return a?NaN:(p?-1:1)*(1/0);a+=Math.pow(2,n),o-=f}return(p?-1:1)*a*Math.pow(2,o-n)},i=function(t,e,r,n,i,o){var a,s,l,f=8*o-i-1,u=(1<<f)-1,c=u>>1,d=23===i?5960464477539062e-23:0,p=n?0:o-1,h=n?1:-1,m=e<0||0===e&&1/e<0?1:0;for(isNaN(e=Math.abs(e))||e===1/0?(s=isNaN(e)?1:0,a=u):(a=Math.floor(Math.log(e)/Math.LN2),e*(l=Math.pow(2,-a))<1&&(a--,l*=2),a+c>=1?e+=d/l:e+=d*Math.pow(2,1-c),e*l>=2&&(a++,l/=2),a+c>=u?(s=0,a=u):a+c>=1?(s=(e*l-1)*Math.pow(2,i),a+=c):(s=e*Math.pow(2,c-1)*Math.pow(2,i),a=0));i>=8;t[r+p]=255&s,p+=h,s/=256,i-=8);for(a=a<<i|s,f+=i;f>0;t[r+p]=255&a,p+=h,a/=256,f-=8);t[r+p-h]|=128*m}}),i.register("JRZh2",function(e,r){t(e.exports,"default",function(){return o});var n=i("c4C4W"),o=class{constructor(){this.handlers=[]}/**
   ...
   *
   * @returns {void}
   */forEach(t){(0,n.default).forEach(this.handlers,function(e){null!==e&&t(e)})}}}),i.register("k04r0",function(e,r){t(e.exports,"default",function(){return c});var n=i("jrAxF"),o=i("lXDKh"),a=i("c74ni"),s=i("dW1zJ"),l=i("gHHim"),f=i("fA43c");/**
...
self instanceof WorkerGlobalScope&&"function"==typeof self.importScripts;var u={isBrowser:!0,classes:{URLSearchParams:o.default,FormData:a.default,Blob:s.default},isStandardBrowserEnv:l,isStandardBrowserWebWorkerEnv:f,protocols:["http","https","file","blob","url","data"]}}),i.register("i5Hs4",function(e,r){t(e.exports,"default",function(){return o});var n=i("8zJup"),o="undefined"!=typeof URLSearchParams?URLSearchParams:n.default}),i.register("aIGDF",function(e,r){t(e.exports,"default",function(){return n});var n="undefined"!=typeof FormData?FormData:null}),i.register("3ZFaa",function(e,r){t(e.exports,"default",function(){return n});var n="undefined"!=typeof Blob?Blob:null}),i.register("gipWz",function(e,r){t(e.exports,"default",function(){return o});var n=i("c4C4W"),o=/**
...
e.matches(".character-img, .character-name")&&((0,a.onModalOpenCharactersClick)({target:e},r),console.log("rerenderCharacters"))});let p=async t=>{let e=t.target.dataset.id;(0,o.showLoader)();try{let t=await (0,n.api).getComicById({comicId:e}),r=t[0].creators.items.map(t=>t.resourceURI.split("/").pop()),i=t[0].characters.items.map(t=>t.resourceURI.split("/").pop());t[0].authors=t[0].creators.items.map(({name:t,role:e})=>({name:t,role:e}));let a=r[0],s=await (0,n.api).getCreatorsById({creatorId:a});t[0].authors[0].pic=`${s[0].thumbnail.path}.${s[0].thumbnail.extension}`,console.log("creatorId =>",r[0]);for(let e=0;e<i.length;e+=1){let r=i[e],o=await (0,n.api).getCharactersById({characterId:r});t[0].characters.items[e].pic=`${o[0].thumbnail.path}.${o[0].thumbnail.extension}`,t[0].characters.items[e].id=r}l.classList.remove("display-is-hidden"),console.log("comicsDataById =>",t),c.innerHTML="";let d=g(t[0]);u.innerHTML=d,f.style.visibility="visible",(0,o.hideLoader)()}catch(t){(0,o.hideLoader)(),(0,s.Notify).failure("This information is missing")}},h=t=>t.slice(0,3).map(t=>`<li>
 ...
 <div class="box-description-comics">
  ...
  `}}),i.register("hC9mB",function(e,r){t(e.exports,"onModalOpenCharactersClick",function(){return h});var n=i("7lKJl"),o=i("81V9Z"),a=i("bfVKR"),s=i("h6c0i");let l=document.querySelector(".js-modal-section-characters"),f=document.querySelector(".js-modal-close-btn"),u=document.querySelector(".js-markup-modal-characters"),c=document.querySelector(".js-markup-modal-comics"),d=document.querySelector(".modal-container-characters"),p=document.querySelector(".js-click-delegate-comics");f.addEventListener("click",()=>{u.innerHTML="",d.style.visibility="hidden",l.classList.add("display-is-hidden")}),p.addEventListener("click",t=>{let e=t.target,r=e.dataset.id;// Елемент, на який було клікнуто
// Перевіряємо, чи клікнуто на певному дитячому елементі
e.matches(".modal-comics-img, .comics-title")&&(0,a.onModalComicsClick)({target:e},r)});let h=async t=>{let e=t.target.dataset.id;(0,o.showLoader)();try{let t=await (0,n.api).getCharactersById({characterId:e}),r=t[0].series.items.map(t=>t.resourceURI.split("/").pop()),i=t[0].comics.items.map(t=>t.resourceURI.split("/").pop());for(let e=0;e<3;e+=1){let o=i[e],a=r[e];t[0][`comic${e}`]=await (0,n.api).getComicById({comicId:o}),t[0][`series${e}`]=await (0,n.api).getSeriesById({seriesId:a})}c.innerHTML="";let a=`
  ${m(t[0])}
  ${y(t[0])}
`;d.style.visibility="visible",u.innerHTML=a,l.classList.remove("display-is-hidden"),(0,o.hideLoader)()}catch(t){(0,o.hideLoader)(),(0,s.Notify).failure("This information is missing")}},m=t=>{let{thumbnail:e,series0:r,series1:n,series2:i,name:o}=t,a=`
  ...
  <div class="wraper-comics">
     ...
     `;return c}}),i.register("h6c0i",function(t,r){var n,i;n=void 0!==e?e:"undefined"!=typeof window?window:t.exports,i=function(t){// COMMON: SSR check: begin
...
var C=function(){A=setTimeout(function(){N()},e.timeout),B=setTimeout(function(){S()},e.timeout+e.cssAnimationDuration)};C(),e.pauseOnHover&&(E.addEventListener("mouseenter",function(){E.classList.add("nx-paused"),clearTimeout(A),clearTimeout(B)}),E.addEventListener("mouseleave",function(){E.classList.remove("nx-paused"),C()}));// pause auto remove: end
}// else auto remove: end
}// remove by timeout or click: end
// notify - show only the last one: begin
if(e.showOnlyTheLastOne&&u>0)for(var O=t.document.querySelectorAll("[id^="+e.ID+"-]:not([id="+e.ID+"-"+u+"])"),k=0;k<O.length;k++){var I=O[k];null!==I.parentNode&&I.parentNode.removeChild(I)}// notify - show only the last one: end
...
info:function(t,e,n){c(r.Info,t,e,n)}}};return"object"==typeof t.Notiflix?s(!0,t.Notiflix,{Notify:d.Notify}):{Notify:d.Notify}},"function"==typeof define&&define.amd?define([],function(){return i(n)}):"object"==typeof t.exports?t.exports=i(n):n.Notiflix=i(n)})}();//# sourceMappingURL=characters.6ad64c71.js.map

//# sourceMappingURL=characters.6ad64c71.js.map
