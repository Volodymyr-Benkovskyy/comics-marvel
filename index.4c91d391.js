...
let{toString:y}=Object.prototype,{getPrototypeOf:m}=Object,b=(e=Object.create(null),t=>{let r=y.call(t);return e[r]||(e[r]=r.slice(8,-1).toLowerCase())}),w=t=>(t=t.toLowerCase(),e=>b(e)===t),E=t=>e=>typeof e===t,{isArray:A}=Array,v=E("undefined"),O=w("ArrayBuffer"),B=E("string"),S=E("function"),R=E("number"),T=t=>null!==t&&"object"==typeof t,x=t=>{if("object"!==b(t))return!1;let e=m(t);return(null===e||e===Object.prototype||null===Object.getPrototypeOf(e))&&!(Symbol.toStringTag in t)&&!(Symbol.iterator in t)},U=w("Date"),I=w("File"),j=w("Blob"),C=w("FileList"),L=w("URLSearchParams");/**
 ...
 */function K(t,e,r,n,i){Error.call(this),Error.captureStackTrace?Error.captureStackTrace(this,this.constructor):this.stack=Error().stack,this.message=t,this.name="AxiosError",e&&(this.code=e),r&&(this.config=r),n&&(this.request=n),i&&(this.response=i)}W.inherits(K,Error,{toJSON:function(){return{// Standard
...
K.from=(t,e,r,n,i,o)=>{let s=Object.create(G);return W.toFlatObject(t,s,function(t){return t!==Error.prototype},t=>"isAxiosError"!==t),K.call(s,t.message,e,r,n,i),s.cause=t,s.name=t.name,o&&Object.assign(s,o),s},l=function(t){// go through the array every three bytes, we'll deal with trailing stuff later
...
let i=!1;for(;;)switch(e){case"ascii":case"latin1":case"binary":return r;case"utf8":case"utf-8":return tC(t).length;case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":return 2*r;case"hex":return r>>>1;case"base64":return tL(t).length;default:if(i)return n?-1:tC(t).length// assume utf8
...
delete this.name}get code(){return t}set code(t){Object.defineProperty(this,"code",{configurable:!0,enumerable:!0,value:t,writable:!0})}toString(){return`${this.name} [${t}]: ${this.message}`}}}function tT(t){let e="",r=t.length,n="-"===t[0]?1:0;for(;r>=n+4;r-=3)e=`_${t.slice(r-3,r)}${e}`;return`${t.slice(0,r)}${e}`}function tx(t,e,r,n,i,o){if(t>r||t<e){let n;let i="bigint"==typeof e?"n":"";throw n=o>3?0===e||e===BigInt(0)?`>= 0${i} and < 2${i} ** ${(o+1)*8}${i}`:`>= -(2${i} ** ${(o+1)*8-1}${i}) and < 2 ** ${(o+1)*8-1}${i}`:`>= ${e}${i} and <= ${r}${i}`,new tS.ERR_OUT_OF_RANGE("value",n,t)}tU(i,"offset"),(void 0===n[i]||void 0===n[i+o])&&tI(i,n.length-(o+1))}function tU(t,e){if("number"!=typeof t)throw new tS.ERR_INVALID_ARG_TYPE(e,"number",t)}function tI(t,e,r){if(Math.floor(t)!==t)throw tU(t,r),new tS.ERR_OUT_OF_RANGE(r||"offset","an integer",t);if(e<0)throw new tS.ERR_BUFFER_OUT_OF_BOUNDS;throw new tS.ERR_OUT_OF_RANGE(r||"offset",`>= ${r?1:0} and <= ${e}`,t)}tR("ERR_BUFFER_OUT_OF_BOUNDS",function(t){return t?`${t} is outside of buffer bounds`:"Attempt to access memory outside buffer bounds"},RangeError),tR("ERR_INVALID_ARG_TYPE",function(t,e){return`The "${t}" argument must be of type number. Received type ${typeof e}`},TypeError),tR("ERR_OUT_OF_RANGE",function(t,e,r){let n=`The value of "${t}" is out of range.`,i=r;return Number.isInteger(r)&&Math.abs(r)>4294967296?i=tT(String(r)):"bigint"==typeof r&&(i=String(r),(r>BigInt(2)**BigInt(32)||r<-(BigInt(2)**BigInt(32)))&&(i=tT(i)),i+="n"),n+=` It must be ${e}. Received ${i}`},RangeError);// HELPER FUNCTIONS
// ================
let tj=/[^+/0-9A-Za-z-_]/g;function tC(t,e){let r;e=e||1/0;let n=t.length,i=null,o=[];for(let s=0;s<n;++s){// is surrogate component
...
function tD(t){return"undefined"==typeof BigInt?tF:t}function tF(){throw Error("BigInt not supported")}/**
 ...
 */function t$(t){return W.endsWith(t,"[]")?t.slice(0,-2):t}/**
...
t=t$(t),!r&&e?"["+t+"]":t)}).join(r?".":""):e}let tq=W.toFlatObject(W,{},null,function(t){return/^is[A-Z]/.test(t)});var tz=/**
...
return!W.isUndefined(e[t])});let n=r.metaTokens,i=r.visitor||f,o=r.dots,s=r.indexes,a=r.Blob||"undefined"!=typeof Blob&&Blob,l=a&&W.isSpecCompliantForm(e);if(!W.isFunction(i))throw TypeError("visitor must be a function");function u(t){if(null===t)return"";if(W.isDate(t))return t.toISOString();if(!l&&W.isBlob(t))throw new K("Blob is not supported. Use a Buffer instead.");return W.isArrayBuffer(t)||W.isTypedArray(t)?l&&"function"==typeof Blob?new Blob([t]):to.from(t):t}/**
   * Default visitor.
   *
   * @param {*} value
   ...
   */function f(t,r,i){let a=t;if(t&&!i&&"object"==typeof t){if(W.endsWith(r,"{}"))// eslint-disable-next-line no-param-reassign
r=n?r:r.slice(0,-2),// eslint-disable-next-line no-param-reassign
t=JSON.stringify(t);else{var l;if(W.isArray(t)&&(l=t,W.isArray(l)&&!l.some(tk))||(W.isFileList(t)||W.endsWith(r,"[]"))&&(a=W.toArray(t)))return(// eslint-disable-next-line no-param-reassign
r=t$(r),a.forEach(function(t,n){W.isUndefined(t)||null===t||e.append(!0===s?tM([r],n,o):null===s?r:r+"[]",u(t))}),!1)}}return!!tk(t)||(e.append(tM(i,r,o),u(t)),!1)}let c=[],h=Object.assign(tq,{defaultVisitor:f,convertValue:u,isVisitable:tk});if(!W.isObject(t))throw TypeError("data must be an object");return!function t(r,n){if(!W.isUndefined(r)){if(-1!==c.indexOf(r))throw Error("Circular reference detected in "+n.join("."));c.push(r),W.forEach(r,function(r,o){let s=!(W.isUndefined(r)||null===r)&&i.call(e,r,W.isString(o)?o.trim():o,n,h);!0===s&&t(r,n?n.concat(o):[o])}),c.pop()}}(t),e};/**
 ...
 *
 * @returns {void}
 */function tJ(t,e){this._pairs=[],t&&tz(t,this,e)}let tV=tJ.prototype;/**
 ...
 */function tW(t){return encodeURIComponent(t).replace(/%3A/gi,":").replace(/%24/g,"$").replace(/%2C/gi,",").replace(/%20/g,"+").replace(/%5B/gi,"[").replace(/%5D/gi,"]")}function tK(t,e,r){let n;/*eslint no-param-reassign:0*/if(!e)return t;let i=r&&r.encode||tW,o=r&&r.serialize;if(n=o?o(e,r):W.isURLSearchParams(e)?e.toString():new tJ(e,r).toString(i)){let e=t.indexOf("#");-1!==e&&(t=t.slice(0,e)),t+=(-1===t.indexOf("?")?"?":"&")+n}return t}tV.append=function(t,e){this._pairs.push([t,e])},tV.toString=function(t){let e=t?function(e){return t.call(this,e,tH)}:tH;return this._pairs.map(function(t){return e(t[0])+"="+e(t[1])},"").join("&")};var tG=class{constructor(){this.handlers=[]}/**
   ...
   *
   * @returns {void}
   */forEach(t){W.forEach(this.handlers,function(e){null!==e&&t(e)})}},tY={silentJSONParsing:!0,forcedJSONParsing:!0,clarifyTimeoutError:!1},tX="undefined"!=typeof URLSearchParams?URLSearchParams:tJ,tZ="undefined"!=typeof FormData?FormData:null,tQ="undefined"!=typeof Blob?Blob:null;/**
 ...
 */function(t){if(W.isFormData(t)&&W.isFunction(t.entries)){let e={};return W.forEachEntry(t,(t,r)=>{!function t(e,r,n,i){let o=e[i++],s=Number.isFinite(+o),a=i>=e.length;if(o=!o&&W.isArray(n)?n.length:o,a)return W.hasOwnProp(n,o)?n[o]=[n[o],r]:n[o]=r,!s;n[o]&&W.isObject(n[o])||(n[o]=[]);let l=t(e,r,n[o],i);return l&&W.isArray(n[o])&&(n[o]=/**
 * Convert an array to an object.
 *
 * @param {Array<any>} arr - The array to convert to an object.
 *
 * @returns An object with the same keys and values as the array.
 */function(t){let e,r;let n={},i=Object.keys(t),o=i.length;for(e=0;e<o;e++)n[r=i[e]]=t[r];return n}(n[o])),!s}(W.matchAll(/\w+|\[(\w*)]/g,t).map(t=>"[]"===t[0]?"":t[1]||t[0]),r,e,0)}),e}return null};let t5={transitional:tY,adapter:t2.isNode?"http":"xhr",transformRequest:[function(t,e){let r;let n=e.getContentType()||"",i=n.indexOf("application/json")>-1,o=W.isObject(t);o&&W.isHTMLForm(t)&&(t=new FormData(t));let s=W.isFormData(t);if(s)return i&&i?JSON.stringify(t6(t)):t;if(W.isArrayBuffer(t)||W.isBuffer(t)||W.isStream(t)||W.isFile(t)||W.isBlob(t))return t;if(W.isArrayBufferView(t))return t.buffer;if(W.isURLSearchParams(t))return e.setContentType("application/x-www-form-urlencoded;charset=utf-8",!1),t.toString();if(o){if(n.indexOf("application/x-www-form-urlencoded")>-1){var a,l;return(a=t,l=this.formSerializer,tz(a,new t2.classes.URLSearchParams,Object.assign({visitor:function(t,e,r,n){return t2.isNode&&W.isBuffer(t)?(this.append(e,t.toString("base64")),!1):n.defaultVisitor.apply(this,arguments)}},l))).toString()}if((r=W.isFileList(t))||n.indexOf("multipart/form-data")>-1){let e=this.env&&this.env.FormData;return tz(r?{"files[]":t}:t,e&&new e,this.formSerializer)}}return o||i?(e.setContentType("application/json",!1),/**
 ...
 */function(t,e,r){if(W.isString(t))try{return(0,JSON.parse)(t),W.trim(t)}catch(t){if("SyntaxError"!==t.name)throw t}return(0,JSON.stringify)(t)}(t)):t}],transformResponse:[function(t){let e=this.transitional||t5.transitional,r=e&&e.forcedJSONParsing,n="json"===this.responseType;if(t&&W.isString(t)&&(r&&!this.responseType||n)){let r=e&&e.silentJSONParsing;try{return JSON.parse(t)}catch(t){if(!r&&n){if("SyntaxError"===t.name)throw K.from(t,K.ERR_BAD_RESPONSE,this,null,this.response);throw t}}}return t}],/**
   * A timeout in milliseconds to abort a request. If set to 0 (default) a
   * timeout is not created.
   */timeout:0,xsrfCookieName:"XSRF-TOKEN",xsrfHeaderName:"X-XSRF-TOKEN",maxContentLength:-1,maxBodyLength:-1,env:{FormData:t2.classes.FormData,Blob:t2.classes.Blob},validateStatus:function(t){return t>=200&&t<300},headers:{common:{Accept:"application/json, text/plain, */*","Content-Type":void 0}}};W.forEach(["delete","get","head","post","put","patch"],t=>{t5.headers[t]={}});// RawAxiosHeaders whose duplicates are ignored by node
// c.f. https://nodejs.org/api/http.html#http_message_headers
let t3=W.toObjectSet(["age","authorization","content-length","content-type","etag","expires","from","host","if-modified-since","if-unmodified-since","last-modified","location","max-forwards","proxy-authorization","referer","retry-after","user-agent"]);var /**
 ...
 */t4=t=>{let e,r,n;let i={};return t&&t.split("\n").forEach(function(t){n=t.indexOf(":"),e=t.substring(0,n).trim().toLowerCase(),r=t.substring(n+1).trim(),!e||i[e]&&t3[e]||("set-cookie"===e?i[e]?i[e].push(r):i[e]=[r]:i[e]=i[e]?i[e]+", "+r:r)}),i};let t8=Symbol("internals");function t7(t){return t&&String(t).trim().toLowerCase()}function t9(t){return!1===t||null==t?t:W.isArray(t)?t.map(t9):String(t)}let et=t=>/^[-_a-zA-Z0-9^`|~,!#$%&'*+.]+$/.test(t.trim());function ee(t,e,r,n,i){if(W.isFunction(n))return n.call(this,e,r);if(i&&(e=r),W.isString(e)){if(W.isString(n))return -1!==e.indexOf(n);if(W.isRegExp(n))return n.test(e)}}class er{constructor(t){t&&this.set(t)}set(t,e,r){let n=this;function i(t,e,r){let i=t7(e);if(!i)throw Error("header name must be a non-empty string");let o=W.findKey(n,i);o&&void 0!==n[o]&&!0!==r&&(void 0!==r||!1===n[o])||(n[o||e]=t9(t))}let o=(t,e)=>W.forEach(t,(t,r)=>i(t,r,e));return W.isPlainObject(t)||t instanceof this.constructor?o(t,e):W.isString(t)&&(t=t.trim())&&!et(t)?o(t4(t),e):null!=t&&i(e,t,r),this}get(t,e){if(t=t7(t)){let r=W.findKey(this,t);if(r){let t=this[r];if(!e)return t;if(!0===e)return function(t){let e;let r=Object.create(null),n=/([^\s,;=]+)\s*(?:=\s*([^,;]+))?/g;for(;e=n.exec(t);)r[e[1]]=e[2];return r}(t);if(W.isFunction(e))return e.call(this,t,r);if(W.isRegExp(e))return e.exec(t);throw TypeError("parser must be boolean|regexp|function")}}}has(t,e){if(t=t7(t)){let r=W.findKey(this,t);return!!(r&&void 0!==this[r]&&(!e||ee(this,this[r],r,e)))}return!1}delete(t,e){let r=this,n=!1;function i(t){if(t=t7(t)){let i=W.findKey(r,t);i&&(!e||ee(r,r[i],i,e))&&(delete r[i],n=!0)}}return W.isArray(t)?t.forEach(i):i(t),n}clear(t){let e=Object.keys(this),r=e.length,n=!1;for(;r--;){let i=e[r];(!t||ee(this,this[i],i,t,!0))&&(delete this[i],n=!0)}return n}normalize(t){let e=this,r={};return W.forEach(this,(n,i)=>{let o=W.findKey(r,i);if(o){e[o]=t9(n),delete e[i];return}let s=t?i.trim().toLowerCase().replace(/([a-z\d])(\w*)/g,(t,e,r)=>e.toUpperCase()+r):String(i).trim();s!==i&&delete e[i],e[s]=t9(n),r[s]=!0}),this}concat(...t){return this.constructor.concat(this,...t)}toJSON(t){let e=Object.create(null);return W.forEach(this,(r,n)=>{null!=r&&!1!==r&&(e[n]=t&&W.isArray(r)?r.join(", "):r)}),e}[Symbol.iterator](){return Object.entries(this.toJSON())[Symbol.iterator]()}toString(){return Object.entries(this.toJSON()).map(([t,e])=>t+": "+e).join("\n")}get[Symbol.toStringTag](){return"AxiosHeaders"}static from(t){return t instanceof this?t:new this(t)}static concat(t,...e){let r=new this(t);return e.forEach(t=>r.set(t)),r}static accessor(t){let e=this[t8]=this[t8]={accessors:{}},r=e.accessors,n=this.prototype;function i(t){let e=t7(t);r[e]||(!function(t,e){let r=W.toCamelCase(" "+e);["get","set","has"].forEach(n=>{Object.defineProperty(t,n+r,{value:function(t,r,i){return this[n].call(this,e,t,r,i)},configurable:!0})})}(n,t),r[e]=!0)}return W.isArray(t)?t.forEach(i):i(t),this}}function en(t,e){let r=this||t5,n=e||r,i=er.from(n.headers),o=n.data;return W.forEach(t,function(t){o=t.call(r,o,i.normalize(),e?e.status:void 0)}),i.normalize(),o}function ei(t){return!!(t&&t.__CANCEL__)}/**
 ...
 */function eo(t,e,r){K.call(this,null==t?"canceled":t,K.ERR_CANCELED,e,r),this.name="CanceledError"}er.accessor(["Content-Type","Content-Length","Accept","Accept-Encoding","User-Agent","Authorization"]),W.reduceDescriptors(er.prototype,({value:t},e)=>{let r=e[0].toUpperCase()+e.slice(1);// map `set` => `Set`
return{get:()=>t,set(t){this[r]=t}}}),W.freezeMethods(er),W.inherits(eo,K,{__CANCEL__:!0});var es=t2.isStandardBrowserEnv?{write:function(t,e,r,n,i,o){let s=[];s.push(t+"="+encodeURIComponent(e)),W.isNumber(r)&&s.push("expires="+new Date(r).toGMTString()),W.isString(n)&&s.push("path="+n),W.isString(i)&&s.push("domain="+i),!0===o&&s.push("secure"),document.cookie=s.join("; ")},read:function(t){let e=document.cookie.match(RegExp("(^|;\\s*)("+t+")=([^;]*)"));return e?decodeURIComponent(e[3]):null},remove:function(t){this.write(t,"",Date.now()-864e5)}}:{write:function(){},read:function(){return null},remove:function(){}};function ea(t,e){return t&&!/^([a-z][a-z\d+\-.]*:)?\/\//i.test(e)?e?t.replace(/\/+$/,"")+"/"+e.replace(/^\/+/,""):t:e}var el=t2.isStandardBrowserEnv?// whether the request URL is of the same origin as current location.
...
l.send(i||null)})};let ep={http:null,xhr:eh};W.forEach(ep,(t,e)=>{if(t){try{Object.defineProperty(t,"name",{value:e})}catch(t){// eslint-disable-next-line no-empty
}Object.defineProperty(t,"adapterName",{value:e})}});var ed={getAdapter:t=>{let e,r;t=W.isArray(t)?t:[t];let{length:n}=t;for(let i=0;i<n&&(e=t[i],!(r=W.isString(e)?ep[e.toLowerCase()]:e));i++);if(!r){if(!1===r)throw new K(`Adapter ${e} is not supported by the environment`,"ERR_NOT_SUPPORT");throw Error(W.hasOwnProp(ep,e)?`Adapter '${e}' is not available in the build`:`Unknown adapter '${e}'`)}if(!W.isFunction(r))throw TypeError("adapter is not a function");return r},adapters:ep};/**
 ...
 */function t(e){let r=new eB(e),n=g(eB.prototype.request,r);return W.extend(n,eB.prototype,r,{allOwnKeys:!0}),W.extend(n,r,null,{allOwnKeys:!0}),// Factory for creating new instances
...
eT.isAxiosError=function(t){return W.isObject(t)&&!0===t.isAxiosError},// Expose mergeConfig
eT.mergeConfig=eb,eT.AxiosHeaders=er,eT.formToJSON=t=>t6(W.isHTMLForm(t)?new FormData(t):t),eT.getAdapter=ed.getAdapter,eT.HttpStatusCode=eR,eT.default=eT;// This module is intended to unwrap Axios default export as named.
// Keep top-level export same with static properties
// so that it can keep same with es module or cjs
let{Axios:ex,AxiosError:eU,CanceledError:eI,isCancel:ej,CancelToken:eC,VERSION:eL,all:eN,Cancel:e_,isAxiosError:eP,spread:eD,toFormData:eF,AxiosHeaders:ek,HttpStatusCode:e$,formToJSON:eM,getAdapter:eq,mergeConfig:ez}=eT;var eH={};n=d("19JXX"),i=d("h0JH0").utf8,o=d("gixTh"),s=d("h0JH0").bin,// Auxiliary functions
...
a._blocksize=16,a._digestsize=16,eH=function(t,e){if(null==t)throw Error("Illegal argument "+t);var r=n.wordsToBytes(a(t,e));return e&&e.asBytes?r:e&&e.asString?s.bytesToString(r):n.bytesToHex(r)};let eJ="efe513042744199e2ee71f94d9988717",eV=eT.create({baseURL:"https://gateway.marvel.com/v1/public",params:{apikey:eJ,hash:(({timeStamp:t,PUBLIC_KEY:e,PRIVATE_KEY:r})=>{var n;return((n=eH)&&n.__esModule?n.default:n)(`${t}${r}${e}`)})({timeStamp:1,PRIVATE_KEY:"5488535f3958164a14b37ef40df2b28b6e569641",PUBLIC_KEY:eJ}),ts:1}}),eW={getCharacters:async({limit:t=60,offset:e=0,nameStartsWith:r="",comics:n="",orderBy:i="",modifiedSince:o=""})=>{try{let s=await eV.get("/characters",{params:{...t&&{limit:t},...e&&{offset:e},...r&&{nameStartsWith:r},...n&&{comics:n},...i&&{orderBy:i},...o&&{modifiedSince:o}}}),a=s.data.data;return a}catch(t){return{error:t.message}}},getComics:async({limit:t=20,offset:e=0,startYear:r=0,format:n="",title:i="",titleStartsWith:o="",orderBy:s="",dateDescriptor:a=""})=>{try{let l=await eV.get("/comics",{params:{...t&&{limit:t},...e&&{offset:e},...r&&{startYear:r},...o&&{titleStartsWith:o},...n&&{format:n},...i&&{title:i},...s&&{orderBy:s},...a&&{dateDescriptor:a}}}),u=l.data.data;return u}catch(t){return console.log(t),{error:t.message}}}};var eK={};Object.defineProperty(eK,"Spinner",{get:function(){return eX},set:void 0,enumerable:!0,configurable:!0});var eG=function(){return(eG=Object.assign||function(t){for(var e,r=1,n=arguments.length;r<n;r++)for(var i in e=arguments[r])Object.prototype.hasOwnProperty.call(e,i)&&(t[i]=e[i]);return t}).apply(this,arguments)},eY={lines:12,length:7,width:5,radius:10,scale:1,corners:1,color:"#000",fadeColor:"transparent",animation:"spinner-line-fade-default",rotate:0,direction:1,speed:1,zIndex:2e9,className:"spinner",top:"50%",left:"50%",shadow:"0 0 1px transparent",position:"absolute"},eX=/** @class */function(){function t(t){void 0===t&&(t={}),this.opts=eG(eG({},eY),t)}return(/**
 ...
 */function eQ(t,e){return"string"==typeof t?t:t[e%t.length]}let e0=new(0,eK.Spinner)({lines:16,length:18,width:4,radius:20,color:"#600404"}).spin(),e1=()=>{let t=document.getElementById("loader-container");t.innerHTML="",t.appendChild(e0.el),t.style.display="flex"},e2=()=>{let t=document.getElementById("loader-container");t.style.display="none",t.innerHTML=""},e6=document.querySelector(".js-header-search"),e5=document.querySelector(".js-header-form"),e3=null;e3=(()=>{let t={mobile:320,tablet:768};return window.innerWidth<=t.mobile?5:window.innerWidth<=t.tablet?8:16})();let e4=t=>t.map(t=>`<li class="header-search-item">
    ...
    </li>`).join("");return e},rh=t=>{rl.insertAdjacentHTML("beforeend",rc(t))},rp=async()=>{try{let t=await eW.getCharacters("/characters"),{results:e}=t;e=e.filter(({name:t,thumbnail:{path:e}})=>t&&!e.includes("not_available"));let r=[],n=[...e];for(let t=0;t<5&&n.length>0;t++){let t=Math.floor(Math.random()*n.length),e=n[t];r.push(e),n.splice(t,1)}console.log(r),rf(r),rh(r),slideImagesArray=document.querySelectorAll(".js-slide"),slideDescriptionsArray=document.querySelectorAll(".js-random-characters-description"),setInterval(rs,3500)}catch(t){return console.log(t),location.replace("../error.html"),{error:t.message}}};rp();let rd=document.querySelector(".js-last-comics-list"),rg=t=>{let e=t.map(({id:t,thumbnail:e,title:r,creators:n})=>`  <li class= "last-comics-item swiper-slide" data-id="${t}" width="auto">
     <picture>
      <source media="(min-width: 1440px)"
                  srcset="${e.path}.${e.extension}" />
      <source media="(min-width: 768px)"
    ...
    </li>`).join("");return e},ry=t=>{rd.insertAdjacentHTML("beforeend",rg(t))},rm=async()=>{try{let t=await eW.getComics({limit:3,dateDescriptor:"lastWeek"});ry(t.results)}catch(t){console.log(t)}};rm(),new Swiper(".section-comics-swiper",{slidesPerView:1,spaceBetween:15,scrollbar:{el:".swiper-scrollbar",draggable:!0},breakpoints:{375:{slidesPerView:1},768:{slidesPerView:1.5},1440:{slidesPerView:3,init:!1}}})}();//# sourceMappingURL=index.4c91d391.js.map

//# sourceMappingURL=index.4c91d391.js.map
