...
console.log("Error!",e)}};eo.addEventListener("input",/*@__PURE__*/e(c)(eD,2e3)),ei.addEventListener("change",eD);let eC=document.querySelector(".js-sort-btn-reset"),eM=document.getElementById("calendar");eM._flatpickr,eC.addEventListener("click",()=>{(0,r.hideLoader)(),location.reload()});var o=i("7lKJl"),s=i("2xl03"),r=i("81V9Z");let ew=document.querySelector(".js-header-search-characters"),e_=document.querySelector(".js-header-form-characters"),ex=null;ex=(0,s.getItemsPerPage)();let eE=()=>{ew.scrollIntoView({behavior:"smooth"})},eT=async e=>{e.preventDefault();let{target:t}=e,n=t.elements.searchQuery.value;if(e_.reset(),""!==n)try{(0,r.showLoader)();let e=await (0,o.api).getCharacters({nameStartsWith:n,limit:ex,offset:0});if(0===e.total){(0,r.hideLoader)(),eE();return}(0,r.hideLoader)(),eE(),ep(),em(e.results)}catch(e){location.replace("../error.html"),(0,r.hideLoader)()}};e_.addEventListener("submit",eT);let eP=document.querySelector(".header-characters");window.addEventListener("scroll",()=>{0!==scrollY?eP.classList.add("js-header-bg-characters"):eP.classList.remove("js-header-bg-characters")});let ek=document.querySelector(".js-characters-home-btn"),eI=document.querySelector(".js-characters-sort-section");ek.addEventListener("click",()=>{eI.scrollIntoView({behavior:"smooth"})})}();//# sourceMappingURL=characters.3c015ccb.js.map

//# sourceMappingURL=characters.3c015ccb.js.map
