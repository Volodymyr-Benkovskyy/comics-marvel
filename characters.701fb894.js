...
console.log("Error!",e)}};eo.addEventListener("input",/*@__PURE__*/e(c)(eD,2e3)),ei.addEventListener("change",eD);let eC=document.querySelector(".js-sort-btn-reset");eC.addEventListener("click",()=>{(0,r.hideLoader)(),location.reload()});var o=i("7lKJl"),s=i("2xl03"),r=i("81V9Z");let eM=document.querySelector(".js-header-search-characters"),ew=document.querySelector(".js-header-form-characters"),e_=null;e_=(0,s.getItemsPerPage)();let ex=()=>{eM.scrollIntoView({behavior:"smooth"})},eE=async e=>{e.preventDefault();let{target:t}=e,n=t.elements.searchQuery.value;if(ew.reset(),""!==n)try{(0,r.showLoader)();let e=await (0,o.api).getCharacters({nameStartsWith:n,limit:e_,offset:0});if(0===e.total){(0,r.hideLoader)(),ex();return}(0,r.hideLoader)(),ex(),ep(),em(e.results)}catch(e){location.replace("../error.html"),(0,r.hideLoader)()}};ew.addEventListener("submit",eE);let eT=document.querySelector(".header-characters");window.addEventListener("scroll",()=>{0!==scrollY?eT.classList.add("js-header-bg-characters"):eT.classList.remove("js-header-bg-characters")});let eP=document.querySelector(".js-characters-home-btn"),ek=document.querySelector(".js-characters-sort-section");eP.addEventListener("click",()=>{ek.scrollIntoView({behavior:"smooth"})})}();//# sourceMappingURL=characters.701fb894.js.map

//# sourceMappingURL=characters.701fb894.js.map
