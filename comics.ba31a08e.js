...
let i=document.querySelector(".header-comics");window.addEventListener("scroll",()=>{0!==scrollY?i.classList.add("js-header-bg-comics"):i.classList.remove("js-header-bg-comics")});var r=o("7lKJl"),l=o("81V9Z"),a=o("2xl03"),c=o("1VFfL");let n="",d="",m="",u=null;u=(0,a.getItemsPerPage)();let h=document.querySelector(".js-comics-sort-form"),f=document.querySelector(".js-comics-sort-container"),g=document.getElementById("comics-list"),v=e=>e.map(({id:e,thumbnail:t,title:s})=>`<li class="comics-sort-item">
    ...
    `).join(""),y=()=>{f.innerHTML=""},L=e=>{f.insertAdjacentHTML("beforeend",v(e))},p=()=>{g.scrollIntoView({behavior:"smooth"})},w=document.querySelector(".tui-pagination"),S={totalItems:0,itemsPerPage:u,visiblePages:3},b=new(c&&c.__esModule?c.default:c)(w,S),E=async()=>{(0,l.showLoader)();try{let e=await (0,r.api).getComics({limit:u,offset:0});(0,l.hideLoader)(),y(),L(e.results),w.classList.remove("is-hidden"),b.reset(e.total),b.on("beforeMove",async e=>{let t=e.page,s=u*(t+1);try{(0,l.showLoader)();let e=await (0,r.api).getComics({offset:s,limit:u,titleStartsWith:n,format:d,orderBy:m});(0,l.hideLoader)(),y(),L(e.results),p()}catch(e){}})}catch(e){}};E();let j=document.querySelector(".js-comics-input-title"),q=document.querySelector(".js-comics-select-format"),x=document.querySelector(".js-comics-select-order");document.querySelector(".js-comics-select-year");let C=async(e,t)=>{/*   if (event.target === inputTitleEl) {
  ...
  } */if(e.preventDefault(),e.target===j)n=j.value;else if(e.target===q)d=q.value;else if(e.target===x){let e=x.value;"Title"===e?m="title":"On Sale Date"===e&&(m="onsaleDate")}try{(0,l.showLoader)();let e=await (0,r.api).getComics({limit:u,titleStartsWith:n,format:d,orderBy:m});if(console.log(e),0===e.results.length){//sortList.innerHTML = '<div class="nothing-seach"></div>';
w.classList.add("is-hidden"),(0,l.hideLoader)();return}(0,l.hideLoader)(),y(),L(e.results),p(),j.value=""}catch(e){(0,l.hideLoader)(),console.log(e)}};q.addEventListener("change",e=>handleSelectChange(e,"selectFormatEl")),x.addEventListener("change",e=>handleSelectChange(e,"selectComicsOrderEl")),x.addEventListener("change",C),q.addEventListener("change",C),h.addEventListener("submit",C)}();//# sourceMappingURL=comics.ba31a08e.js.map

//# sourceMappingURL=comics.ba31a08e.js.map
