 ...
 *
 * @returns {void}
 */function tV(t,e){this._pairs=[],t&&tz(t,this,e)}const tW=tV.prototype;/**
 ...
 */function tJ(t){return encodeURIComponent(t).replace(/%3A/gi,":").replace(/%24/g,"$").replace(/%2C/gi,",").replace(/%20/g,"+").replace(/%5B/gi,"[").replace(/%5D/gi,"]")}function tG(t,e,r){let n;/*eslint no-param-reassign:0*/if(!e)return t;let i=r&&r.encode||tJ,o=r&&r.serialize;if(n=o?o(e,r):J.isURLSearchParams(e)?e.toString():new tV(e,r).toString(i)){let e=t.indexOf("#");-1!==e&&(t=t.slice(0,e)),t+=(-1===t.indexOf("?")?"?":"&")+n}return t}tW.append=function(t,e){this._pairs.push([t,e])},tW.toString=function(t){let e=t?function(e){return t.call(this,e,tH)}:tH;return this._pairs.map(function(t){return e(t[0])+"="+e(t[1])},"").join("&")};var tK=class{constructor(){this.handlers=[]}/**
   ...
   *
   * @returns {void}
   */forEach(t){J.forEach(this.handlers,function(e){null!==e&&t(e)})}},tY={silentJSONParsing:!0,forcedJSONParsing:!0,clarifyTimeoutError:!1},tZ="undefined"!=typeof URLSearchParams?URLSearchParams:tV,tX="undefined"!=typeof FormData?FormData:null,tQ="undefined"!=typeof Blob?Blob:null;/**
...
a._blocksize=16,a._digestsize=16,eH=function(t,e){if(null==t)throw Error("Illegal argument "+t);var r=n.wordsToBytes(a(t,e));return e&&e.asBytes?r:e&&e.asString?s.bytesToString(r):n.bytesToHex(r)};const eV="efe513042744199e2ee71f94d9988717",eW=eT.create({baseURL:"https://gateway.marvel.com/v1/public",params:{apikey:eV,hash:(({timeStamp:t,PUBLIC_KEY:e,PRIVATE_KEY:r})=>{var n;return((n=eH)&&n.__esModule?n.default:n)(`${t}${r}${e}`)})({timeStamp:1,PRIVATE_KEY:"5488535f3958164a14b37ef40df2b28b6e569641",PUBLIC_KEY:eV}),ts:1}}),eJ={getCharacters:async({limit:t=60,offset:e=0,nameStartsWith:r="",comics:n="",orderBy:i="",modifiedSince:o=""})=>{try{let s=await eW.get("/characters",{params:{...t&&{limit:t},...e&&{offset:e},...r&&{nameStartsWith:r},...n&&{comics:n},...i&&{orderBy:i},...o&&{modifiedSince:o}}}),a=s.data.data;return a}catch(t){return{error:t.message}}},getComics:async({limit:t=20,offset:e=0,startYear:r=0,format:n="",title:i="",titleStartsWith:o="",orderBy:s="",dateDescriptor:a=""})=>{try{let l=await eW.get("/comics",{params:{...t&&{limit:t},...e&&{offset:e},...r&&{startYear:r},...o&&{titleStartsWith:o},...n&&{format:n},...i&&{title:i},...s&&{orderBy:s},...a&&{dateDescriptor:a}}}),u=l.data.data;return u}catch(t){return console.log(t),{error:t.message}}}};var eG={};Object.defineProperty(eG,"Spinner",{get:function(){return eZ},set:void 0,enumerable:!0,configurable:!0});var eK=function(){return(eK=Object.assign||function(t){for(var e,r=1,n=arguments.length;r<n;r++)for(var i in e=arguments[r])Object.prototype.hasOwnProperty.call(e,i)&&(t[i]=e[i]);return t}).apply(this,arguments)},eY={lines:12,length:7,width:5,radius:10,scale:1,corners:1,color:"#000",fadeColor:"transparent",animation:"spinner-line-fade-default",rotate:0,direction:1,speed:1,zIndex:2e9,className:"spinner",top:"50%",left:"50%",shadow:"0 0 1px transparent",position:"absolute"},eZ=/** @class */function(){function t(t){void 0===t&&(t={}),this.opts=eK(eK({},eY),t)}return(/**
 ...
 */function eQ(t,e){return"string"==typeof t?t:t[e%t.length]}const e0=new(0,eG.Spinner)({lines:16,length:18,width:4,radius:20,color:"#600404"}).spin(),e1=()=>{let t=document.getElementById("loader-container");t.innerHTML="",t.appendChild(e0.el),t.style.display="flex"},e2=()=>{let t=document.getElementById("loader-container");t.style.display="none",t.innerHTML=""},e6=document.querySelector(".js-header-search"),e5=document.querySelector(".js-header-form");let e3=null;e3=(()=>{let t={mobile:320,tablet:768};return window.innerWidth<=t.mobile?5:window.innerWidth<=t.tablet?8:16})();const e4=t=>t.map(t=>`<li class="header-search-item">
    ...
    </li>`).join("");return e},rh=t=>{rl.insertAdjacentHTML("beforeend",rc(t))},rp=async()=>{try{let t=await eJ.getCharacters("/characters"),{results:e}=t;e=e.filter(({name:t,thumbnail:{path:e}})=>t&&!e.includes("not_available"));let r=[],n=[...e];for(let t=0;t<5&&n.length>0;t++){let t=Math.floor(Math.random()*n.length),e=n[t];r.push(e),n.splice(t,1)}console.log(r),rf(r),rh(r),slideImagesArray=document.querySelectorAll(".js-slide"),slideDescriptionsArray=document.querySelectorAll(".js-random-characters-description"),setInterval(rs,3500)}catch(t){return console.log(t),location.replace("../error.html"),{error:t.message}}};rp();const rd=document.querySelector(".js-last-comics-list"),rg=t=>{let e=t.map(({id:t,thumbnail:e,title:r,creators:n})=>`  <li class= "last-comics-item swiper-slide" data-id="${t}" width="auto">
     <picture>
      <source media="(min-width: 1440px)"
                  srcset="${e.path}.${e.extension}" />
      <source media="(min-width: 768px)"
    ...
    </li>`).join("");return e},ry=t=>{rd.insertAdjacentHTML("beforeend",rg(t))},rm=async()=>{try{let t=await eJ.getComics({limit:3,dateDescriptor:"lastWeek"});ry(t.results)}catch(t){console.log(t)}};rm(),new Swiper(".section-comics-swiper",{slidesPerView:1,spaceBetween:15,scrollbar:{el:".swiper-scrollbar",draggable:!0},breakpoints:{375:{slidesPerView:1},768:{slidesPerView:1.5},1440:{slidesPerView:3,init:!1}}});//# sourceMappingURL=index.58612435.js.map

//# sourceMappingURL=index.58612435.js.map
