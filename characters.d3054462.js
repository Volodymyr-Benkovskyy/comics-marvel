...
console.log("Error!",e)}};eo.addEventListener("input",/*@__PURE__*/e(c)(eD,2e3)),ei.addEventListener("change",eD);var o=i("iRoAB"),s=i("cH1ne"),r=i("jKGAa");const eC=document.querySelector(".js-header-search-characters"),eM=document.querySelector(".js-header-form-characters");let ew=null;ew=(0,s.getItemsPerPage)();const e_=()=>{eC.scrollIntoView({behavior:"smooth"})},ex=async e=>{e.preventDefault();let{target:t}=e,n=t.elements.searchQuery.value;if(eM.reset(),""!==n)try{(0,r.showLoader)();let e=await (0,o.api).getCharacters({nameStartsWith:n,limit:ew,offset:0});if(0===e.total){(0,r.hideLoader)();return}(0,r.hideLoader)(),e_(),em(e.results)}catch(e){location.replace("../error.html"),(0,r.hideLoader)()}};eM.addEventListener("submit",ex);const eE=document.querySelector(".header-characters");window.addEventListener("scroll",()=>{0!==scrollY?eE.classList.add("js-header-bg-characters"):eE.classList.remove("js-header-bg-characters")});//# sourceMappingURL=characters.d3054462.js.map

//# sourceMappingURL=characters.d3054462.js.map
