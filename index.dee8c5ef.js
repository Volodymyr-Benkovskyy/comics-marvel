...
t.results.forEach(t=>{t.thumbnail.path.startsWith("https://")||(t.thumbnail.path=t.thumbnail.path.replace("http://","https://"))}),rE(t.results)}catch(t){console.log(t)}};rv(),new Swiper(".section-comics-swiper",{slidesPerView:1,spaceBetween:15,scrollbar:{el:".swiper-scrollbar",draggable:!0},breakpoints:{375:{slidesPerView:1},768:{slidesPerView:1.5},1440:{slidesPerView:3,init:!1}}})}();//# sourceMappingURL=index.dee8c5ef.js.map

//# sourceMappingURL=index.dee8c5ef.js.map
