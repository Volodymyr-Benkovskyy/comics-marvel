...
// ================
const tC=/[^+/0-9A-Za-z-_]/g;function tj(t,e){let r;e=e||1/0;let n=t.length,i=null,o=[];for(let s=0;s<n;++s){// is surrogate component
...
return!J.isUndefined(e[t])});let n=r.metaTokens,i=r.visitor||f,o=r.dots,s=r.indexes,a=r.Blob||"undefined"!=typeof Blob&&Blob,u=a&&J.isSpecCompliantForm(e);if(!J.isFunction(i))throw TypeError("visitor must be a function");function l(t){if(null===t)return"";if(J.isDate(t))return t.toISOString();if(!u&&J.isBlob(t))throw new G("Blob is not supported. Use a Buffer instead.");return J.isArrayBuffer(t)||J.isTypedArray(t)?u&&"function"==typeof Blob?new Blob([t]):to.from(t):t}/**
   * Default visitor.
   *
   * @param {*} value
...
t=JSON.stringify(t);else{var u;if(J.isArray(t)&&(u=t,J.isArray(u)&&!u.some(tk))||(J.isFileList(t)||J.endsWith(r,"[]"))&&(a=J.toArray(t)))return(// eslint-disable-next-line no-param-reassign
r=tM(r),a.forEach(function(t,n){J.isUndefined(t)||null===t||e.append(!0===s?t$([r],n,o):null===s?r:r+"[]",l(t))}),!1)}}return!!tk(t)||(e.append(t$(i,r,o),l(t)),!1)}let c=[],h=Object.assign(tq,{defaultVisitor:f,convertValue:l,isVisitable:tk});if(!J.isObject(t))throw TypeError("data must be an object");return!function t(r,n){if(!J.isUndefined(r)){if(-1!==c.indexOf(r))throw Error("Circular reference detected in "+n.join("."));c.push(r),J.forEach(r,function(r,o){let s=!(J.isUndefined(r)||null===r)&&i.call(e,r,J.isString(o)?o.trim():o,n,h);!0===s&&t(r,n?n.concat(o):[o])}),c.pop()}}(t),e};/**
...
if(u.open(t.method.toUpperCase(),tG(l,t.params,t.paramsSerializer),!0),// Set the request timeout in MS
...
n=e=>{u&&(r(!e||e.type?new eo(null,t,u):e),u.abort(),u=null)},t.cancelToken&&t.cancelToken.subscribe(n),t.signal&&(t.signal.aborted?n():t.signal.addEventListener("abort",n)));let c=function(t){let e=/^([-+\w]{1,25})(:?\/\/|:)/.exec(t);return e&&e[1]||""}(l);if(c&&-1===t2.protocols.indexOf(c)){r(new G("Unsupported protocol "+c+":",G.ERR_BAD_REQUEST,t));return}// Send the request
...
const{Axios:eU,AxiosError:ex,CanceledError:eI,isCancel:eC,CancelToken:ej,VERSION:eL,all:eN,Cancel:e_,isAxiosError:eP,spread:eF,toFormData:eD,AxiosHeaders:ek,HttpStatusCode:eM,formToJSON:e$,getAdapter:eq,mergeConfig:ez}=eT;var eH={};n=d("fSg2G"),i=d("28Nm5").utf8,o=d("c8cSi"),s=d("28Nm5").bin,// Auxiliary functions
 ...
 */function eQ(t,e){return"string"==typeof t?t:t[e%t.length]}const e0=new(0,eG.Spinner)({lines:16,length:18,width:4,radius:20,color:"#600404"}).spin(),e1=()=>{let t=document.getElementById("loader-container");t.innerHTML="",t.appendChild(e0.el),t.style.display="flex"},e2=()=>{let t=document.getElementById("loader-container");t.style.display="none",t.innerHTML=""},e6=document.querySelector(".js-header-search"),e5=document.querySelector(".js-header-form");let e3=null;e3=(()=>{let t={mobile:320,tablet:768};return window.innerWidth<=t.mobile?5:window.innerWidth<=t.tablet?8:16})();const e4=t=>t.map(t=>`<li class="header-search-item">
    ...
    `).join(""),e8=t=>{e6.insertAdjacentHTML("beforeend",e4(t))},e7=()=>{e6.scrollIntoView({behavior:"smooth"})},e9=()=>{e6.innerHTML=""},rt=async t=>{t.preventDefault();let{target:e}=t,r=e.elements.searchQuery.value;if(e5.reset(),""!==r)try{e1();let t=await eJ.getCharacters({nameStartsWith:r,limit:e3,offset:0});if(0===t.results.length){e2(),e7(),e6.innerHTML='<div class="nothing-seach"></div>';return}e2(),e9(),e8(t.results),e7()}catch(t){location.replace("../error.html"),e2()}};e5.addEventListener("submit",rt);const re=document.querySelector(".header");window.addEventListener("scroll",()=>{0!==scrollY?re.classList.add("js-header-bg"):re.classList.remove("js-header-bg")}),new Swiper(".section-hero-swiper",{direction:"vertical",loop:!0,pagination:{el:".swiper-pagination",clickable:!0},spaceBetween:50,slidesPerView:1,initialSlide:0});const rr=document.querySelector(".swiper-pagination"),rn=document.querySelector(".js-btn-color");rr.addEventListener("click",t=>{let{target:e}=t,r=e.getAttribute("aria-label"),n="";"Go to slide 1"===r?(n="#600404",rn.style.background=n):"Go to slide 2"===r?(n="#34387f",rn.style.background=n):"Go to slide 3"===r&&(n="#5b7f3c",rn.style.background=n)}),slideImagesArray=null,slideDescriptionsArray=null;let ri=0,ro=0;const rs=()=>{for(let t=0;t<slideImagesArray.length;t+=1)slideImagesArray[t].classList.remove("js-show"),slideImagesArray[t].classList.add("js-slide");for(let t=0;t<slideDescriptionsArray.length;t+=1)slideDescriptionsArray[t].classList.remove("js-active"),slideDescriptionsArray[t].classList.add("js-random-characters-description");ro=(ro+2)%slideImagesArray.length,ri=(ri+1)%slideDescriptionsArray.length,slideImagesArray[ro].classList.add("js-show"),slideImagesArray[ro].classList.remove("js-slide"),slideDescriptionsArray[ri].classList.add("js-active"),slideDescriptionsArray[ri].classList.remove("js-random-characters-description")},ra=document.querySelector(".js-random-img"),ru=document.querySelector(".js-random-descr"),rl=t=>{let e=t.map(({id:t,thumbnail:e,name:r})=>`  <li class= "js-slide js-random-characters-img" data-id="${t}">
      ...
      <img class="js-random-characters-img" data-id="${t}"
        ...
        alt='${r}'
      /></picture>
    </li>`).join("");return e},rf=t=>{ra.insertAdjacentHTML("beforeend",rl(t))},rc=t=>{let e=t.map(({name:t,description:e,id:r})=>`
    ...
    </li>`).join("");return e},rh=t=>{ru.insertAdjacentHTML("beforeend",rc(t))},rp=async()=>{try{let t=await eJ.getCharacters("/characters",{params:{limit:10,offset:0}}),{results:e}=t;e=e.filter(({description:t,thumbnail:{path:e}})=>t.length&&!e.includes("not_available"));let r=[];for(let t=0;t<5;t+=1){let t=Math.floor(Math.random()*e.length),n=e[t];r.includes(n)||r.push(n)}console.log(r),rf(r),rh(r),slideImagesArray=document.querySelectorAll(".js-slide"),slideDescriptionsArray=document.querySelectorAll(".js-random-characters-description"),setInterval(rs,3500)}catch(t){return console.log(t),location.replace("../error.html"),{error:t.message}}};rp();//# sourceMappingURL=index.47e29b7f.js.map
