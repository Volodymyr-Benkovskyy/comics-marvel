...
G.from=(t,e,r,n,i,o)=>{let s=Object.create(K);return J.toFlatObject(t,s,function(t){return t!==Error.prototype},t=>"isAxiosError"!==t),G.call(s,t.message,e,r,n,i),s.cause=t,s.name=t.name,o&&Object.assign(s,o),s},l=function(t){// go through the array every three bytes, we'll deal with trailing stuff later
...
X["-".charCodeAt(0)]=62,X["_".charCodeAt(0)]=63,u=function(t,e,r,n,i){var o,s,a=8*i-n-1,l=(1<<a)-1,u=l>>1,f=-7,c=r?i-1:0,h=r?-1:1,p=t[e+c];for(c+=h,o=p&(1<<-f)-1,p>>=-f,f+=a;f>0;o=256*o+t[e+c],c+=h,f-=8);for(s=o&(1<<-f)-1,o>>=-f,f+=n;f>0;s=256*s+t[e+c],c+=h,f-=8);if(0===o)o=1-u;else{if(o===l)return s?NaN:(p?-1:1)*(1/0);s+=Math.pow(2,n),o-=u}return(p?-1:1)*s*Math.pow(2,o-n)},f=function(t,e,r,n,i,o){var s,a,l,u=8*o-i-1,f=(1<<u)-1,c=f>>1,h=23===i?5960464477539062e-23:0,p=n?0:o-1,d=n?1:-1,g=e<0||0===e&&1/e<0?1:0;for(isNaN(e=Math.abs(e))||e===1/0?(a=isNaN(e)?1:0,s=f):(s=Math.floor(Math.log(e)/Math.LN2),e*(l=Math.pow(2,-s))<1&&(s--,l*=2),s+c>=1?e+=h/l:e+=h*Math.pow(2,1-c),e*l>=2&&(s++,l/=2),s+c>=f?(a=0,s=f):s+c>=1?(a=(e*l-1)*Math.pow(2,i),s+=c):(a=e*Math.pow(2,c-1)*Math.pow(2,i),s=0));i>=8;t[r+p]=255&a,p+=d,a/=256,i-=8);for(s=s<<i|a,u+=i;u>0;t[r+p]=255&s,p+=d,s/=256,u-=8);t[r+p-d]|=128*g};const tn="function"==typeof Symbol&&"function"// eslint-disable-line dot-notation
...
// ================
const tj=/[^+/0-9A-Za-z-_]/g;function tC(t,e){let r;e=e||1/0;let n=t.length,i=null,o=[];for(let s=0;s<n;++s){// is surrogate component
...
var r=t.indexOf("=");-1===r&&(r=e);var n=r===e?0:4-r%4;return[r,n]}(t),i=n[0],o=n[1],s=new Q((i+o)*3/4-o),a=0,l=o>0?i-4:i;for(r=0;r<l;r+=4)e=X[t.charCodeAt(r)]<<18|X[t.charCodeAt(r+1)]<<12|X[t.charCodeAt(r+2)]<<6|X[t.charCodeAt(r+3)],s[a++]=e>>16&255,s[a++]=e>>8&255,s[a++]=255&e;return 2===o&&(e=X[t.charCodeAt(r)]<<2|X[t.charCodeAt(r+1)]>>4,s[a++]=255&e),1===o&&(e=X[t.charCodeAt(r)]<<10|X[t.charCodeAt(r+1)]<<4|X[t.charCodeAt(r+2)]>>2,s[a++]=e>>8&255,s[a++]=255&e),s}(function(t){// Node converts strings with length < 2 to ''
 ...
 *
 * @returns {boolean}
 */function tk(t){return J.isPlainObject(t)||J.isArray(t)}/**
 * It removes the brackets from the end of a string
 *
 * @param {string} key - The key of the parameter.
 *
 * @returns {string} the key without the brackets.
 */function t$(t){return J.endsWith(t,"[]")?t.slice(0,-2):t}/**
...
t=t$(t),!r&&e?"["+t+"]":t)}).join(r?".":""):e}const tq=J.toFlatObject(J,{},null,function(t){return/^is[A-Z]/.test(t)});var tz=/**
...
return!J.isUndefined(e[t])});let n=r.metaTokens,i=r.visitor||f,o=r.dots,s=r.indexes,a=r.Blob||"undefined"!=typeof Blob&&Blob,l=a&&J.isSpecCompliantForm(e);if(!J.isFunction(i))throw TypeError("visitor must be a function");function u(t){if(null===t)return"";if(J.isDate(t))return t.toISOString();if(!l&&J.isBlob(t))throw new G("Blob is not supported. Use a Buffer instead.");return J.isArrayBuffer(t)||J.isTypedArray(t)?l&&"function"==typeof Blob?new Blob([t]):to.from(t):t}/**
   * Default visitor.
   *
   * @param {*} value
...
r.setAttribute("href",n),n=r.href),r.setAttribute("href",n),{href:r.href,protocol:r.protocol?r.protocol.replace(/:$/,""):"",host:r.host,search:r.search?r.search.replace(/^\?/,""):"",hash:r.hash?r.hash.replace(/^#/,""):"",hostname:r.hostname,port:r.port,pathname:"/"===r.pathname.charAt(0)?r.pathname:"/"+r.pathname}}/**
    ...
    */return t=n(window.location.href),function(e){let r=J.isString(e)?n(e):e;return r.protocol===t.protocol&&r.host===t.host}}():function(){return!0},eu=/**
 * Calculate data maxRate
 * @param {Number} [samplesCount= 10]
 * @param {Number} [min= 1000]
 * @returns {Function}
 */function(t,e){let r;t=t||10;let n=Array(t),i=Array(t),o=0,s=0;return e=void 0!==e?e:1e3,function(a){let l=Date.now(),u=i[s];r||(r=l),n[o]=a,i[o]=l;let f=s,c=0;for(;f!==o;)c+=n[f++],f%=t;if((o=(o+1)%t)===s&&(s=(s+1)%t),l-r<e)return;let h=u&&l-u;return h?Math.round(1e3*c/h):void 0}};function ef(t,e){let r=0,n=eu(50,250);return i=>{let o=i.loaded,s=i.lengthComputable?i.total:void 0,a=o-r,l=n(a),u=o<=s;r=o;let f={loaded:o,total:s,progress:s?o/s:void 0,bytes:a,rate:l||void 0,estimated:l&&s&&u?(s-o)/l:void 0,event:i};f[e?"download":"upload"]=!0,t(f)}}const ec="undefined"!=typeof XMLHttpRequest;var eh=ec&&function(t){return new Promise(function(e,r){let n,i=t.data,o=er.from(t.headers).normalize(),s=t.responseType;function a(){t.cancelToken&&t.cancelToken.unsubscribe(n),t.signal&&t.signal.removeEventListener("abort",n)}J.isFormData(i)&&(t2.isStandardBrowserEnv||t2.isStandardBrowserWebWorkerEnv?o.setContentType(!1):o.setContentType("multipart/form-data;",!1));let l=new XMLHttpRequest;// HTTP basic authentication
...
let n=er.from("getAllResponseHeaders"in l&&l.getAllResponseHeaders()),i=s&&"text"!==s&&"json"!==s?l.response:l.responseText,o={data:i,status:l.status,statusText:l.statusText,headers:n,config:t,request:l};!function(t,e,r){let n=r.config.validateStatus;!r.status||!n||n(r.status)?t(r):e(new G("Request failed with status code "+r.status,[G.ERR_BAD_REQUEST,G.ERR_BAD_RESPONSE][Math.floor(r.status/100)-4],r.config,r.request,r))}(function(t){e(t),a()},function(t){r(t),a()},o),// Clean up request
l=null}// Add xsrf header
// This is only done if running in a standard browser environment.
// Specifically not if we're in a web worker, or react-native.
if(l.open(t.method.toUpperCase(),tG(u,t.params,t.paramsSerializer),!0),// Set the request timeout in MS
...
l.onabort=function(){l&&(r(new G("Request aborted",G.ECONNABORTED,t,l)),// Clean up request
l=null)},// Handle low level network errors
l.onerror=function(){// Real errors are hidden from us by the browser
// onerror should only fire if it's a network error
r(new G("Network Error",G.ERR_NETWORK,t,l)),// Clean up request
l=null},// Handle timeout
l.ontimeout=function(){let e=t.timeout?"timeout of "+t.timeout+"ms exceeded":"timeout exceeded",n=t.transitional||tY;t.timeoutErrorMessage&&(e=t.timeoutErrorMessage),r(new G(e,n.clarifyTimeoutError?G.ETIMEDOUT:G.ECONNABORTED,t,l)),// Clean up request
...
n=e=>{l&&(r(!e||e.type?new eo(null,t,l):e),l.abort(),l=null)},t.cancelToken&&t.cancelToken.subscribe(n),t.signal&&(t.signal.aborted?n():t.signal.addEventListener("abort",n)));let c=function(t){let e=/^([-+\w]{1,25})(:?\/\/|:)/.exec(t);return e&&e[1]||""}(u);if(c&&-1===t2.protocols.indexOf(c)){r(new G("Unsupported protocol "+c+":",G.ERR_BAD_REQUEST,t));return}// Send the request
l.send(i||null)})};const ep={http:null,xhr:eh};J.forEach(ep,(t,e)=>{if(t){try{Object.defineProperty(t,"name",{value:e})}catch(t){// eslint-disable-next-line no-empty
...
return(r,i,o)=>{if(!1===t)throw new G(n(i," has been removed"+(e?" in "+e:"")),G.ERR_DEPRECATED);return e&&!eA[i]&&(eA[i]=!0,// eslint-disable-next-line no-console
...
const{Axios:ex,AxiosError:eU,CanceledError:eI,isCancel:ej,CancelToken:eC,VERSION:eL,all:eN,Cancel:e_,isAxiosError:eP,spread:eD,toFormData:eF,AxiosHeaders:ek,HttpStatusCode:e$,formToJSON:eM,getAdapter:eq,mergeConfig:ez}=eT;var eH={};n=d("fSg2G"),i=d("28Nm5").utf8,o=d("c8cSi"),s=d("28Nm5").bin,// Auxiliary functions
...
}return r}(n),o=0;o<e.lines;o++){var s=~~(360/e.lines*o+e.rotate),a=eX(document.createElement("div"),{position:"absolute",top:-e.width/2+"px",width:e.length+e.width+"px",height:e.width+"px",background:eQ(e.fadeColor,o),borderRadius:r,transformOrigin:"left",transform:"rotate("+s+"deg) translateX("+e.radius+"px)"}),l=o*e.direction/e.lines/e.speed;l-=1/e.speed;var u=eX(document.createElement("div"),{width:"100%",height:"100%",background:eQ(e.color,o),borderRadius:r,boxShadow:/**
...
function rn(){let t=window.innerWidth<768||window.innerWidth>=1440?"vertical":"horizontal";rr&&rr.destroy(),rr=new Swiper(".section-hero-swiper",{direction:t,loop:!1,pagination:{el:".swiper-pagination",clickable:!0},spaceBetween:50,slidesPerView:1,initialSlide:0})}rn(),window.addEventListener("resize",rn);const ri=document.querySelector(".swiper-pagination"),ro=document.querySelector(".js-btn-color");ri.addEventListener("click",t=>{let{target:e}=t,r=e.getAttribute("aria-label"),n="";"Go to slide 1"===r?(n="#600404",ro.style.background=n):"Go to slide 2"===r?(n="#34387f",ro.style.background=n):"Go to slide 3"===r&&(n="#5b7f3c",ro.style.background=n)}),slideImagesArray=null,slideDescriptionsArray=null;let rs=0,ra=0;const rl=()=>{for(let t=0;t<slideImagesArray.length;t+=1)slideImagesArray[t].classList.remove("js-show"),slideImagesArray[t].classList.add("js-slide");for(let t=0;t<slideDescriptionsArray.length;t+=1)slideDescriptionsArray[t].classList.remove("js-active"),slideDescriptionsArray[t].classList.add("js-random-characters-description");ra=(ra+1)%slideImagesArray.length,rs=(rs+1)%slideDescriptionsArray.length,slideImagesArray[ra].classList.add("js-show"),slideImagesArray[ra].classList.remove("js-slide"),slideDescriptionsArray[rs].classList.add("js-active"),slideDescriptionsArray[rs].classList.remove("js-random-characters-description")},ru=document.querySelector(".js-random-img"),rf=document.querySelector(".js-random-descr"),rc=t=>{let e=t.map(({id:t,thumbnail:e,name:r})=>`  <li class= "js-slide js-random-characters-img" data-id="${t}">
      ...
      <img class="js-random-characters-img" data-id="${t}"
        ...
        alt='${r}'
      /></picture>
    </li>`).join("");return e},rh=t=>{ru.insertAdjacentHTML("beforeend",rc(t))},rp=t=>{let e=t.map(({name:t,description:e,id:r})=>`
    ...
    </li>`).join("");return e},rd=t=>{rf.insertAdjacentHTML("beforeend",rp(t))},rg=async()=>{try{let t=await eJ.getCharacters("/characters"),{results:e}=t;e=e.filter(({name:t,thumbnail:{path:e}})=>t&&!e.includes("not_available"));let r=[],n=[...e];for(let t=0;t<5&&n.length>0;t++){let t=Math.floor(Math.random()*n.length),e=n[t];r.push(e),n.splice(t,1)}console.log(r),rh(r),rd(r),slideImagesArray=document.querySelectorAll(".js-slide"),slideDescriptionsArray=document.querySelectorAll(".js-random-characters-description"),setInterval(rl,3500)}catch(t){return console.log(t),location.replace("../error.html"),{error:t.message}}};rg();const ry=document.querySelector(".js-last-comics-list"),rm=t=>{let e=t.map(({id:t,thumbnail:e,title:r,creators:n})=>`  <li class= "last-comics-item swiper-slide" data-id="${t}" width="auto">
     <picture>
      <source media="(min-width: 1440px)"
                  srcset="${e.path}.${e.extension}" />
      <source media="(min-width: 768px)"
    ...
    </li>`).join("");return e},rb=t=>{ry.insertAdjacentHTML("beforeend",rm(t))},rw=async()=>{try{let t=await eJ.getComics({limit:3,dateDescriptor:"lastWeek"});rb(t.results)}catch(t){console.log(t)}};rw(),new Swiper(".section-comics-swiper",{slidesPerView:1,spaceBetween:15,scrollbar:{el:".swiper-scrollbar",draggable:!0},breakpoints:{375:{slidesPerView:1},768:{slidesPerView:1.5},1440:{slidesPerView:3,init:!1}}});//# sourceMappingURL=index.fd48f9e2.js.map

//# sourceMappingURL=index.fd48f9e2.js.map
