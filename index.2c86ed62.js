 ...
 */function t$(t){return V.endsWith(t,"[]")?t.slice(0,-2):t}/**
...
t=t$(t),!r&&e?"["+t+"]":t)}).join(r?".":""):e}let tq=V.toFlatObject(V,{},null,function(t){return/^is[A-Z]/.test(t)});var tz=/**
 ...
 *
 * @returns {void}
 */function tW(t,e){this._pairs=[],t&&tz(t,this,e)}let tJ=tW.prototype;/**
 ...
 */function tV(t){return encodeURIComponent(t).replace(/%3A/gi,":").replace(/%24/g,"$").replace(/%2C/gi,",").replace(/%20/g,"+").replace(/%5B/gi,"[").replace(/%5D/gi,"]")}function tK(t,e,r){let n;/*eslint no-param-reassign:0*/if(!e)return t;let i=r&&r.encode||tV,o=r&&r.serialize;if(n=o?o(e,r):V.isURLSearchParams(e)?e.toString():new tW(e,r).toString(i)){let e=t.indexOf("#");-1!==e&&(t=t.slice(0,e)),t+=(-1===t.indexOf("?")?"?":"&")+n}return t}tJ.append=function(t,e){this._pairs.push([t,e])},tJ.toString=function(t){let e=t?function(e){return t.call(this,e,tH)}:tH;return this._pairs.map(function(t){return e(t[0])+"="+e(t[1])},"").join("&")};var tG=class{constructor(){this.handlers=[]}/**
   ...
   *
   * @returns {void}
   */forEach(t){V.forEach(this.handlers,function(e){null!==e&&t(e)})}},tY={silentJSONParsing:!0,forcedJSONParsing:!0,clarifyTimeoutError:!1},tX="undefined"!=typeof URLSearchParams?URLSearchParams:tW,tZ="undefined"!=typeof FormData?FormData:null,tQ="undefined"!=typeof Blob?Blob:null;/**
...
a._blocksize=16,a._digestsize=16,eH=function(t,e){if(null==t)throw Error("Illegal argument "+t);var r=n.wordsToBytes(a(t,e));return e&&e.asBytes?r:e&&e.asString?s.bytesToString(r):n.bytesToHex(r)};let eW="efe513042744199e2ee71f94d9988717",eJ=eT.create({baseURL:"https://gateway.marvel.com/v1/public",params:{apikey:eW,hash:(({timeStamp:t,PUBLIC_KEY:e,PRIVATE_KEY:r})=>{var n;return((n=eH)&&n.__esModule?n.default:n)(`${t}${r}${e}`)})({timeStamp:1,PRIVATE_KEY:"5488535f3958164a14b37ef40df2b28b6e569641",PUBLIC_KEY:eW}),ts:1}}),eV={getCharacters:async({limit:t=60,offset:e=0,nameStartsWith:r="",comics:n="",orderBy:i="",modifiedSince:o=""})=>{try{let s=await eJ.get("/characters",{params:{...t&&{limit:t},...e&&{offset:e},...r&&{nameStartsWith:r},...n&&{comics:n},...i&&{orderBy:i},...o&&{modifiedSince:o}}}),a=s.data.data;return a}catch(t){return{error:t.message}}},getComics:async({limit:t=20,offset:e=0,startYear:r=0,format:n="",title:i="",titleStartsWith:o="",orderBy:s="",dateDescriptor:a=""})=>{try{let l=await eJ.get("/comics",{params:{...t&&{limit:t},...e&&{offset:e},...r&&{startYear:r},...o&&{titleStartsWith:o},...n&&{format:n},...i&&{title:i},...s&&{orderBy:s},...a&&{dateDescriptor:a}}}),u=l.data.data;return u}catch(t){return console.log(t),{error:t.message}}}};var eK={};Object.defineProperty(eK,"Spinner",{get:function(){return eX},set:void 0,enumerable:!0,configurable:!0});var eG=function(){return(eG=Object.assign||function(t){for(var e,r=1,n=arguments.length;r<n;r++)for(var i in e=arguments[r])Object.prototype.hasOwnProperty.call(e,i)&&(t[i]=e[i]);return t}).apply(this,arguments)},eY={lines:12,length:7,width:5,radius:10,scale:1,corners:1,color:"#000",fadeColor:"transparent",animation:"spinner-line-fade-default",rotate:0,direction:1,speed:1,zIndex:2e9,className:"spinner",top:"50%",left:"50%",shadow:"0 0 1px transparent",position:"absolute"},eX=/** @class */function(){function t(t){void 0===t&&(t={}),this.opts=eG(eG({},eY),t)}return(/**
...
function rn(){let t=window.innerWidth<768||window.innerWidth>=1440?"vertical":"horizontal";rr&&rr.destroy(),rr=new Swiper(".section-hero-swiper",{direction:t,loop:!1,pagination:{el:".swiper-pagination",clickable:!0},spaceBetween:50,slidesPerView:1,initialSlide:0})}rn(),window.addEventListener("resize",rn);let ri=document.querySelector(".swiper-pagination"),ro=document.querySelector(".js-btn-color");ri.addEventListener("click",t=>{let{target:e}=t,r=e.getAttribute("aria-label"),n="";"Go to slide 1"===r?(n="#600404",ro.style.background=n):"Go to slide 2"===r?(n="#34387f",ro.style.background=n):"Go to slide 3"===r&&(n="#5b7f3c",ro.style.background=n)}),slideImagesArray=null,slideDescriptionsArray=null;let rs=0,ra=0,rl=()=>{for(let t=0;t<slideImagesArray.length;t+=1)slideImagesArray[t].classList.remove("js-show"),slideImagesArray[t].classList.add("js-slide");for(let t=0;t<slideDescriptionsArray.length;t+=1)slideDescriptionsArray[t].classList.remove("js-active"),slideDescriptionsArray[t].classList.add("js-random-characters-description");ra=(ra+1)%slideImagesArray.length,rs=(rs+1)%slideDescriptionsArray.length,slideImagesArray[ra].classList.add("js-show"),slideImagesArray[ra].classList.remove("js-slide"),slideDescriptionsArray[rs].classList.add("js-active"),slideDescriptionsArray[rs].classList.remove("js-random-characters-description")},ru=document.querySelector(".js-random-img"),rf=document.querySelector(".js-random-descr"),rc=t=>{let e=t.map(({id:t,thumbnail:e,name:r})=>`  <li class= "js-slide js-random-characters-img" data-id="${t}">
    ...
    </li>`).join("");return e},rd=t=>{rf.insertAdjacentHTML("beforeend",rp(t))},rg=async()=>{try{let t=await eV.getCharacters("/characters"),{results:e}=t;e=e.filter(({name:t,thumbnail:{path:e}})=>t&&!e.includes("not_available"));let r=[],n=[...e];for(let t=0;t<5&&n.length>0;t++){let t=Math.floor(Math.random()*n.length),e=n[t];r.push(e),n.splice(t,1)}console.log(r),rh(r),rd(r),slideImagesArray=document.querySelectorAll(".js-slide"),slideDescriptionsArray=document.querySelectorAll(".js-random-characters-description"),setInterval(rl,3500)}catch(t){return console.log(t),location.replace("../error.html"),{error:t.message}}};rg();let ry=document.querySelector(".js-last-comics-list"),rm=t=>{let e=t.map(({id:t,thumbnail:e,title:r,creators:n})=>`  <li class= "last-comics-item swiper-slide" data-id="${t}" width="auto">
     <picture>
      <source media="(min-width: 1440px)"
                  srcset="${e.path}.${e.extension}" />
      <source media="(min-width: 768px)"
    ...
    </li>`).join("");return e},rb=t=>{ry.insertAdjacentHTML("beforeend",rm(t))},rw=async()=>{try{let t=await eV.getComics({limit:3,dateDescriptor:"lastWeek"});rb(t.results)}catch(t){console.log(t)}};rw(),new Swiper(".section-comics-swiper",{slidesPerView:1,spaceBetween:15,scrollbar:{el:".swiper-scrollbar",draggable:!0},breakpoints:{375:{slidesPerView:1},768:{slidesPerView:1.5},1440:{slidesPerView:3,init:!1}}})}();//# sourceMappingURL=index.2c86ed62.js.map

//# sourceMappingURL=index.2c86ed62.js.map
