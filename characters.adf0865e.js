...
(0,n.default).call(this,null==t?"canceled":t,n.default.ERR_CANCELED,e,r),this.name="CanceledError"}(0,i("c4C4W").default).inherits(o,n.default,{__CANCEL__:!0});var s=o}),i.register("fA43c",function(e,r){t(e.exports,"default",function(){return f});var n=i("c4C4W"),o=i("beknR"),s=i("btSY7"),a=i("5TB86");let u={http:o.default,xhr:s.default};(0,n.default).forEach(u,(t,e)=>{if(t){try{Object.defineProperty(t,"name",{value:e})}catch(t){// eslint-disable-next-line no-empty
}Object.defineProperty(t,"adapterName",{value:e})}});var f={getAdapter:t=>{let e,r;t=(0,n.default).isArray(t)?t:[t];let{length:i}=t;for(let o=0;o<i&&(e=t[o],!(r=(0,n.default).isString(e)?u[e.toLowerCase()]:e));o++);if(!r){if(!1===r)throw new a.default(`Adapter ${e} is not supported by the environment`,"ERR_NOT_SUPPORT");throw Error((0,n.default).hasOwnProp(u,e)?`Adapter '${e}' is not available in the build`:`Unknown adapter '${e}'`)}if(!(0,n.default).isFunction(r))throw TypeError("adapter is not a function");return r},adapters:u}}),i.register("btSY7",function(e,r){t(e.exports,"default",function(){return w});var n=i("c4C4W"),o=i("j97bH"),s=i("jFG8L"),a=i("6d5Pb"),u=i("gYMA1"),f=i("9jFfm"),l=i("gWbUy"),c=i("5TB86"),d=i("dW1zJ"),h=i("4ULKu"),p=i("d0XKg"),g=i("gHHim"),y=i("dSDGE");function m(t,e){let r=0,n=(0,y.default)(50,250);return i=>{let o=i.loaded,s=i.lengthComputable?i.total:void 0,a=o-r,u=n(a),f=o<=s;r=o;let l={loaded:o,total:s,progress:s?o/s:void 0,bytes:a,rate:u||void 0,estimated:u&&s&&f?(s-o)/u:void 0,event:i};l[e?"download":"upload"]=!0,t(l)}}let b="undefined"!=typeof XMLHttpRequest;var w=b&&function(t){return new Promise(function(e,r){let i,y=t.data,b=(0,g.default).from(t.headers).normalize(),w=t.responseType;function E(){t.cancelToken&&t.cancelToken.unsubscribe(i),t.signal&&t.signal.removeEventListener("abort",i)}(0,n.default).isFormData(y)&&(p.default.isStandardBrowserEnv||p.default.isStandardBrowserWebWorkerEnv?b.setContentType(!1):b.setContentType("multipart/form-data;",!1));let v=new XMLHttpRequest;// HTTP basic authentication
if(t.auth){let e=t.auth.username||"",r=t.auth.password?unescape(encodeURIComponent(t.auth.password)):"";b.set("Authorization","Basic "+btoa(e+":"+r))}let A=(0,u.default)(t.baseURL,t.url);function B(){if(!v)return;// Prepare the response
let n=(0,g.default).from("getAllResponseHeaders"in v&&v.getAllResponseHeaders()),i=w&&"text"!==w&&"json"!==w?v.response:v.responseText,s={data:i,status:v.status,statusText:v.statusText,headers:n,config:t,request:v};(0,o.default)(function(t){e(t),E()},function(t){r(t),E()},s),// Clean up request
...
let e=(t.withCredentials||(0,f.default)(A))&&t.xsrfCookieName&&(0,s.default).read(t.xsrfCookieName);e&&b.set(t.xsrfHeaderName,e)}// Remove Content-Type if data is undefined
...
i=e=>{v&&(r(!e||e.type?new d.default(null,t,v):e),v.abort(),v=null)},t.cancelToken&&t.cancelToken.subscribe(i),t.signal&&(t.signal.aborted?i():t.signal.addEventListener("abort",i)));let O=(0,h.default)(A);if(O&&-1===(0,p.default).protocols.indexOf(O)){r(new c.default("Unsupported protocol "+O+":",c.default.ERR_BAD_REQUEST,t));return}// Send the request
 ...
 *
 * @returns {object}
 */function(t,e,r){if("object"!=typeof t)throw new o.default("options must be an object",o.default.ERR_BAD_OPTION_VALUE);let n=Object.keys(t),i=n.length;for(;i-- >0;){let s=n[i],a=e[s];if(a){let e=t[s],r=void 0===e||a(e,s,t);if(!0!==r)throw new o.default("option "+s+" must be "+r,o.default.ERR_BAD_OPTION_VALUE);continue}if(!0!==r)throw new o.default("Unknown option "+s,o.default.ERR_BAD_OPTION)}},validators:s}}),i.register("kLR29",function(e,r){t(e.exports,"VERSION",function(){return n});let n="1.5.0"}),i.register("77MZz",function(e,r){t(e.exports,"default",function(){return s});var n=i("dW1zJ");/**
 ...
 */function a(t,e){return"string"==typeof t?t:t[e%t.length]}})}();//# sourceMappingURL=characters.adf0865e.js.map

//# sourceMappingURL=characters.adf0865e.js.map
