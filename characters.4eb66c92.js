...
console.log("Error!",e)}};eo.addEventListener("input",/*@__PURE__*/e(c)(eD,2e3)),ei.addEventListener("change",eD);const eC=document.querySelector(".js-sort-btn-reset");eC.addEventListener("click",()=>{(0,r.hideLoader)(),location.reload()});var o=i("iRoAB"),s=i("cH1ne"),r=i("jKGAa");const eM=document.querySelector(".js-header-search-characters"),ew=document.querySelector(".js-header-form-characters");let e_=null;e_=(0,s.getItemsPerPage)();const ex=()=>{eM.scrollIntoView({behavior:"smooth"})},eE=async e=>{e.preventDefault();let{target:t}=e,n=t.elements.searchQuery.value;if(ew.reset(),""!==n)try{(0,r.showLoader)();let e=await (0,o.api).getCharacters({nameStartsWith:n,limit:e_,offset:0});if(0===e.total){(0,r.hideLoader)(),ex();return}(0,r.hideLoader)(),ex(),ep(),em(e.results)}catch(e){location.replace("../error.html"),(0,r.hideLoader)()}};ew.addEventListener("submit",eE);const eT=document.querySelector(".header-characters");window.addEventListener("scroll",()=>{0!==scrollY?eT.classList.add("js-header-bg-characters"):eT.classList.remove("js-header-bg-characters")});const eP=document.querySelector(".js-characters-home-btn"),ek=document.querySelector(".js-characters-sort-section");eP.addEventListener("click",()=>{ek.scrollIntoView({behavior:"smooth"})});//# sourceMappingURL=characters.4eb66c92.js.map

//# sourceMappingURL=characters.4eb66c92.js.map
