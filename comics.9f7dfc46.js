...
const e=document.querySelector(".header-comics");window.addEventListener("scroll",()=>{0!==scrollY?e.classList.add("js-header-bg-comics"):e.classList.remove("js-header-bg-comics")});//# sourceMappingURL=comics.9f7dfc46.js.map

//# sourceMappingURL=comics.9f7dfc46.js.map
